...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,286 | 🐛 2,434 | 🌐 Python | 📅 2026-09-17: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,466 | 🐛 314 | 🌐 Python | 📅 2026-09-17: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,561 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-15: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,173 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,963 | 🐛 69 | 🌐 Python | 📅 2026-09-17: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,939 | 🐛 340 | 🌐 Python | 📅 2026-09-16: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,714 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,935 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,914 | 🐛 1,222 | 🌐 Python | 📅 2026-09-16: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,361 | 🐛 205 | 🌐 Python | 📅 2026-09-17: Differentiable computer vision library.
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,902 | 🐛 331 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,844 | 🐛 3,591 | 🌐 Python | 📅 2026-09-17: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,347 | 🐛 1,085 | 🌐 Python | 📅 2026-09-17: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,157 | 🐛 270 | 🌐 Jupyter Notebook | 📅 2026-09-14: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,085 | 🐛 1,337 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,361 | 🐛 205 | 🌐 Python | 📅 2026-09-17: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,869 | 🐛 104 | 🌐 Python | 📅 2026-09-14 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,823 | 🐛 35 | 🌐 Python | 📅 2026-09-17: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,151 | 🐛 61 | 🌐 Python | 📅 2026-09-15: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,331 | 🐛 259 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
11. [d2l-pytorch](https://github.com/dsgiitr/d2l-pytorch) ⭐ 4,366 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-07-25: This is an attempt to modify Dive into Deep Learning, Berkeley STAT 157 (Spring 2019) textbook's code into PyTorch.
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,221 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,138 | 🐛 6 | 🌐 C++ | 📅 2026-09-13: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,494 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,286 | 🐛 2,434 | 🌐 Python | 📅 2026-09-17: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,794 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
...
100. [vnet.pytorch](https://github.com/mattmacy/vnet.pytorch) ⭐ 758 | 🐛 26 | 🌐 Python | 📅 2018-07-06: A Pytorch implementation for V-Net: Fully Convolutional Neural Networks for Volumetric Medical Image Segmentation.
...
199. [GAM](https://github.com/benedekrozemberczki/GAM) ⭐ 276 | 🐛 3 | 🌐 Python | 📅 2022-11-06: This is a Pytorch implementation of Graph Classification using Structural Attention. KDD 2018.
...
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,909 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
