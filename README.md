...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,700 | 🐛 74 | 🌐 Python | 📅 2026-09-13: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 165,240 | 🐛 2,421 | 🌐 Python | 📅 2026-09-13: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,436 | 🐛 309 | 🌐 Python | 📅 2026-09-13: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,819 | 🐛 187 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,539 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-10: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,171 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,955 | 🐛 54 | 🌐 Python | 📅 2026-09-12: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,935 | 🐛 339 | 🌐 Python | 📅 2026-09-12: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,705 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
...
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,906 | 🐛 1,226 | 🌐 Python | 📅 2026-09-12: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,353 | 🐛 207 | 🌐 Python | 📅 2026-09-13: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,967 | 🐛 316 | 🌐 Python | 📅 2026-09-03: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,947 | 🐛 870 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,893 | 🐛 331 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,464 | 🐛 69 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,526 | 🐛 656 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,055 | 🐛 290 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,594 | 🐛 93 | 🌐 Jupyter Notebook | 📅 2026-09-08: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,786 | 🐛 3,613 | 🌐 Python | 📅 2026-09-13: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,339 | 🐛 1,087 | 🌐 Python | 📅 2026-09-12: Rapid research framework for Pytorch. The researcher's version of keras.
...
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,077 | 🐛 1,332 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,353 | 🐛 207 | 🌐 Python | 📅 2026-09-13: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,864 | 🐛 87 | 🌐 Python | 📅 2026-09-09 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
13. [torchdiffeq](https://github.com/rtqichen/torchdiffeq) ⭐ 6,482 | 🐛 95 | 🌐 Python | 📅 2025-04-04: Differentiable ODE solvers with full GPU support and O(1)-memory backpropagation.
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,171 | 🐛 29 | 🌐 Python | 📅 2026-09-09: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,784 | 🐛 184 | 🌐 Python | 📅 2026-09-09: Ignite is a high-level library to help with training neural networks in PyTorch.
20. [pytorch-summary](https://github.com/sksq96/pytorch-summary) ⭐ 4,053 | 🐛 141 | 🌐 Python | 📅 2024-03-02: Model summary in PyTorch similar to `model.summary()` in Keras
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,799 | 🐛 188 | 🌐 Python | 📅 2026-09-08: Adaptive Experimentation Platform
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,823 | 🐛 38 | 🌐 Python | 📅 2026-09-12: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,431 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,137 | 🐛 59 | 🌐 Python | 📅 2026-09-12: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,038 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,324 | 🐛 258 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,190 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 3 | 🌐 C++ | 📅 2026-09-13: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,491 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 165,240 | 🐛 2,421 | 🌐 Python | 📅 2026-09-13: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
5. [FastPhotoStyle](https://github.com/NVIDIA/FastPhotoStyle) ⭐ 11,173 | 🐛 57 | 🌐 Python | 📅 2023-06-07: A Closed-form Solution to Photorealistic Image Stylization
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,605 | 🐛 4 | 🌐 Python | 📅 2026-09-10: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,560 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
...
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,907 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
7. [AlphaZero\_Gomoku](https://github.com/junxiaosong/AlphaZero_Gomoku) ⭐ 3,628 | 🐛 80 | 🌐 Python | 📅 2024-04-24: An implementation of the AlphaZero algorithm for Gomoku (also called Gobang or Five in a Row)
