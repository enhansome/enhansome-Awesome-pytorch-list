...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,126 | 🐛 2,382 | 🌐 Python | 📅 2026-08-15: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,137 | 🐛 236 | 🌐 Python | 📅 2026-08-16: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,423 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,925 | 🐛 337 | 🌐 Python | 📅 2026-08-15: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,665 | 🐛 586 | 🌐 Python | 📅 2026-07-24: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,875 | 🐛 1,960 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,867 | 🐛 1,196 | 🌐 Python | 📅 2026-08-15: Datasets, Transforms and Models specific to Computer Vision.
...
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,917 | 🐛 868 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,829 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,136 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,793 | 🐛 97 | 🌐 Python | 📅 2026-08-15 - Lightly is a computer vision framework for self-supervised learning.
...
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,584 | 🐛 92 | 🌐 Jupyter Notebook | 📅 2026-08-15: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,524 | 🐛 3,478 | 🌐 Python | 📅 2026-08-16: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,286 | 🐛 1,072 | 🌐 Python | 📅 2026-08-09: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,116 | 🐛 266 | 🌐 Jupyter Notebook | 📅 2026-08-15: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,010 | 🐛 1,306 | 🌐 Python | 📅 2026-07-31: Geometric Deep Learning Extension Library for PyTorch
...
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,819 | 🐛 112 | 🌐 Python | 📅 2026-08-10 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,990 | 🐛 769 | 🌐 Python | 📅 2026-08-10: An Experimental PyTorch Extension(will be deprecated at a later point)
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,160 | 🐛 31 | 🌐 Python | 📅 2026-08-14: PyTorch library aimed at accelerating 3D deep learning research
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,826 | 🐛 34 | 🌐 Python | 📅 2026-08-16: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
46. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,695 | 🐛 15 | 🌐 Python | 📅 2026-08-09: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,451 | 🐛 90 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,072 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,451 | 🐛 90 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,126 | 🐛 2,382 | 🌐 Python | 📅 2026-08-15: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
13. [pix2pixHD](https://github.com/NVIDIA/pix2pixHD) ⭐ 6,930 | 🐛 247 | 🌐 Python | 📅 2024-11-04: Synthesizing and manipulating 2048x1024 images with conditional GANs tcwang0509.github.io/pix2pixHD
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,543 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
...
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,455 | 🐛 8 | 🌐 Python | 📅 2026-08-09
...
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,895 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
