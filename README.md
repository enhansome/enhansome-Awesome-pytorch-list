...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,510 | 🐛 2,402 | 🌐 Python | 📅 2026-09-22: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,489 | 🐛 299 | 🌐 Python | 📅 2026-09-22: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,834 | 🐛 189 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,581 | 🐛 41 | 🌐 Jupyter Notebook | 📅 2026-09-22: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,173 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,963 | 🐛 104 | 🌐 Python | 📅 2026-09-22: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,943 | 🐛 340 | 🌐 Python | 📅 2026-09-21: simple audio I/O for pytorch.
...
27. [voicefilter](https://github.com/mindslab-ai/voicefilter) ⭐ 1,222 | 🐛 13 | 🌐 Python | 📅 2024-07-25: Unofficial PyTorch implementation of Google AI's VoiceFilter system <http://swpark.me/voicefilter>
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,721 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,951 | 🐛 1,963 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,925 | 🐛 1,223 | 🌐 Python | 📅 2026-09-21: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,375 | 🐛 182 | 🌐 Python | 📅 2026-09-22: Differentiable computer vision library.
...
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,955 | 🐛 870 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,915 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
10. [face-alignment](https://github.com/1adrianb/face-alignment) ⭐ 7,539 | 🐛 91 | 🌐 Python | 📅 2026-04-06: :fire: 2D and 3D Face alignment library build using pytorch adrianbulat.com
...
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,160 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,814 | 🐛 107 | 🌐 Python | 📅 2026-09-21 - Lightly is a computer vision framework for self-supervised learning.
17. [image-classification-mobile](https://github.com/osmr/imgclsmob) ⭐ 3,013 | 🐛 14 | 🌐 Python | 📅 2024-09-06: Collection of classification models pretrained on the ImageNet-1K.
...
26. [pytorch-cnn-finetune](https://github.com/creafz/pytorch-cnn-finetune) ⭐ 723 | 🐛 6 | 🌐 Python | 📅 2024-08-16: Fine-tune pretrained Convolutional Neural Networks with PyTorch.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,057 | 🐛 293 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,600 | 🐛 93 | 🌐 Jupyter Notebook | 📅 2026-09-08: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,893 | 🐛 3,612 | 🌐 Python | 📅 2026-09-22: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,356 | 🐛 1,084 | 🌐 Python | 📅 2026-09-21: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,187 | 🐛 271 | 🌐 Jupyter Notebook | 📅 2026-09-21: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,098 | 🐛 1,345 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,375 | 🐛 182 | 🌐 Python | 📅 2026-09-22: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,877 | 🐛 135 | 🌐 Python | 📅 2026-09-21 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,999 | 🐛 770 | 🌐 Python | 📅 2026-09-21: An Experimental PyTorch Extension(will be deprecated at a later point)
...
13. [torchdiffeq](https://github.com/rtqichen/torchdiffeq) ⭐ 6,483 | 🐛 97 | 🌐 Python | 📅 2025-04-04: Differentiable ODE solvers with full GPU support and O(1)-memory backpropagation.
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,174 | 🐛 28 | 🌐 Python | 📅 2026-09-18: PyTorch library aimed at accelerating 3D deep learning research
...
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,915 | 🐛 422 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,915 | 🐛 422 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,197 | 🐛 138 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
30. [pytorch-optimizer](https://github.com/jettify/pytorch-optimizer) ⭐ 3,169 | 🐛 57 | 🌐 Python | 📅 2024-03-22: Collections of modern optimization algorithms for PyTorch, includes: AccSGD, AdaBound, AdaMod, DiffGrad, Lamb, RAdam, RAdam, Yogi.
...
36. [Ax](https://github.com/facebook/Ax) ⭐ 2,807 | 🐛 185 | 🌐 Python | 📅 2026-09-21: Adaptive Experimentation Platform
...
40. [cvxpylayers](https://github.com/cvxgrp/cvxpylayers) ⭐ 2,139 | 🐛 31 | 🌐 Python | 📅 2026-09-19: cvxpylayers is a Python library for constructing differentiable convex optimization layers in PyTorch
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,822 | 🐛 37 | 🌐 Python | 📅 2026-09-22: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
57. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-21: Python library for Reinforcement Learning experiments.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,491 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,164 | 🐛 53 | 🌐 Python | 📅 2026-09-21: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,050 | 🐛 254 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,342 | 🐛 263 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
6. **[PyTorch-Tutorial](https://github.com/MorvanZhou/PyTorch-Tutorial) ⭐ 8,470 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2023-03-23**: Build your neural network easy and fast  <https://morvanzhou.github.io/tutorials/>
7. [Run your PyTorch Example Fedarated with Flower](https://github.com/adap/flower/tree/main/examples/pytorch_from_centralized_to_federated) ⭐ 7,140 | 🐛 388 | 🌐 Python | 📅 2026-09-22: This example demonstrates how an already existing centralized PyTorch machine learning project can be federated with Flower. A Cifar-10 dataset is used together with a convolutional neural network (CNN).
...
9. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 5,611 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
10. [pytorch-sentiment-analysis](https://github.com/bentrevett/pytorch-sentiment-analysis) ⭐ 4,610 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-03-27: Tutorials on getting started with PyTorch and TorchText for sentiment analysis.
...
13. [RL-Adventure](https://github.com/higgsfield/RL-Adventure) ⭐ 3,180 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2021-11-04: Pytorch easy-to-follow step-by-step Deep Q Learning tutorial with clean readable code.
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,510 | 🐛 2,402 | 🌐 Python | 📅 2026-09-22: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,981 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,608 | 🐛 4 | 🌐 Python | 📅 2026-09-10: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,798 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
...
10. [pulse](https://github.com/adamian98/pulse) ⭐ 8,020 | 🐛 61 | 🌐 Python | 📅 2021-04-30: Self-Supervised Photo Upsampling via Latent Space Exploration of Generative Models
...
12. [face-alignment](https://github.com/1adrianb/face-alignment) ⭐ 7,539 | 🐛 91 | 🌐 Python | 📅 2026-04-06: Pytorch implementation of the paper "How far are we from solving the 2D & 3D Face Alignment problem? (and a dataset of 230,000 3D facial landmarks)", ICCV 2017
...
18. [StarGAN](https://github.com/yunjey/StarGAN) ⭐ 5,294 | 🐛 67 | 🌐 Python | 📅 2021-01-23: StarGAN: Unified Generative Adversarial Networks for Multi-Domain Image-to-Image Tranlsation.
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,036 | 🐛 130 | 🌐 Python | 📅 2026-09-21: A Python library for learning and evaluating knowledge graph embeddings.
...
52. [YOLO2](https://github.com/longcw/yolo2-pytorch) ⭐ 1,562 | 🐛 87 | 🌐 Python | 📅 2021-09-29: YOLOv2 in PyTorch.
...
169. [WideResNets](https://github.com/xternalz/WideResNet-pytorch) ⭐ 347 | 🐛 2 | 🌐 Python | 📅 2021-04-29: WideResNets for CIFAR10/100 implemented in PyTorch. This implementation requires less GPU memory than what is required by the official Torch implementation: <https://github.com/szagoruyko/wide-residual-networks> ⭐ 1,315 | 🐛 24 | 🌐 Lua | 📅 2019-08-20 .
170. [tbd-nets](https://github.com/davidmascharka/tbd-nets) ⭐ 347 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2021-12-07: PyTorch implementation of "Transparency by Design: Closing the Gap Between Performance and Interpretability in Visual Reasoning" arxiv.org/abs/1803.05268
...
179. [PyTorchWavelets](https://github.com/tomrunia/PyTorchWavelets) ⭐ 318 | 🐛 5 | 🌐 Python | 📅 2022-02-03: PyTorch implementation of the wavelet analysis found in Torrence and Compo (1998)
...
186. [RetinaNet](https://github.com/c0nn3r/RetinaNet) ⚠️ Archived: An implementation of RetinaNet in PyTorch.
187. [simple-effective-text-matching-pytorch](https://github.com/alibaba-edu/simple-effective-text-matching-pytorch) ⭐ 305 | 🐛 5 | 🌐 Python | 📅 2022-08-24: A pytorch implementation of the ACL2019 paper "Simple and Effective Text Matching with Richer Alignment Features".
...
199. [GAM](https://github.com/benedekrozemberczki/GAM) ⭐ 276 | 🐛 5 | 🌐 Python | 📅 2022-11-06: This is a Pytorch implementation of Graph Classification using Structural Attention. KDD 2018.
...
240. [distance-encoding](https://github.com/snap-stanford/distance-encoding) ⭐ 186 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2021-03-20: Distance-Encoding - Design Provably More PowerfulGNNs for Structural Representation Learning.
241. [Pytorch-DPPO](https://github.com/alexis-jacq/Pytorch-DPPO) ⭐ 185 | 🐛 5 | 🌐 Python | 📅 2018-03-25: Pytorch implementation of Distributed Proximal Policy Optimization: arxiv.org/abs/1707.02286
242. [Deep-Image-Analogy-PyTorch](https://github.com/Ben-Louis/Deep-Image-Analogy-PyTorch) ⭐ 185 | 🐛 4 | 🌐 Python | 📅 2021-12-11: A python implementation of Deep-Image-Analogy based on pytorch.
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,644 | 🐛 4 | 📅 2026-07-22**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,467 | 🐛 10 | 🌐 Python | 📅 2026-09-20
...
5. [pytorch-template](https://github.com/victoresque/pytorch-template) ⭐ 5,122 | 🐛 23 | 🌐 Python | 📅 2024-06-04: PyTorch template project
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,913 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
