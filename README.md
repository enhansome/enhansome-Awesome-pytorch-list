...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,694 | 🐛 64 | 🌐 Python | 📅 2026-08-27: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,566 | 🐛 2,394 | 🌐 Python | 📅 2026-08-28: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,352 | 🐛 290 | 🌐 Python | 📅 2026-08-28: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,788 | 🐛 178 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,481 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,168 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,945 | 🐛 58 | 🌐 Python | 📅 2026-08-28: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,931 | 🐛 338 | 🌐 Python | 📅 2026-08-28: simple audio I/O for pytorch.
...
42. [torch-metrics](https://github.com/enochkan/torch-metrics) ⭐ 110 | 🐛 4 | 🌐 Python | 📅 2026-08-21: Metrics for model evaluation in pytorch
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,692 | 🐛 585 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
...
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,887 | 🐛 1,198 | 🌐 Python | 📅 2026-08-28: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,334 | 🐛 105 | 🌐 Python | 📅 2026-08-28: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,958 | 🐛 312 | 🌐 Python | 📅 2026-08-27: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,933 | 🐛 869 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,859 | 🐛 333 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,519 | 🐛 656 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
13. [facenet-pytorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,162 | 🐛 85 | 🌐 Python | 📅 2025-09-16: Pretrained Pytorch face detection and recognition models ported from davidsandberg/facenet.
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,145 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,800 | 🐛 98 | 🌐 Python | 📅 2026-08-28 - Lightly is a computer vision framework for self-supervised learning.
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,638 | 🐛 3,539 | 🌐 Python | 📅 2026-08-28: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,315 | 🐛 1,079 | 🌐 Python | 📅 2026-08-25: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,128 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2026-08-15: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,043 | 🐛 1,318 | 🌐 Python | 📅 2026-08-24: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,334 | 🐛 105 | 🌐 Python | 📅 2026-08-28: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,841 | 🐛 111 | 🌐 Python | 📅 2026-08-26 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,995 | 🐛 770 | 🌐 Python | 📅 2026-08-27: An Experimental PyTorch Extension(will be deprecated at a later point)
...
11. [tensorboard-pytorch](https://github.com/lanpa/tensorboard-pytorch) ⭐ 7,998 | 🐛 85 | 🌐 Python | 📅 2026-07-14: This module saves PyTorch tensors in tensorboard format for inspection. Currently supports scalar, image, audio, histogram features in tensorboard.
...
24. [pytorchviz](https://github.com/szagoruyko/pytorchviz) ⭐ 3,500 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2024-12-30: A small package to create visualizations of PyTorch execution graphs.
...
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,172 | 🐛 139 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,793 | 🐛 185 | 🌐 Python | 📅 2026-08-19: Adaptive Experimentation Platform
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,824 | 🐛 33 | 🌐 Python | 📅 2026-08-28: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
46. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,695 | 🐛 15 | 🌐 Python | 📅 2026-08-20: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
49. [pytorch-toolbelt](https://github.com/BloodAxe/pytorch-toolbelt) ⭐ 1,574 | 🐛 6 | 🌐 Python | 📅 2025-10-09: PyTorch extensions for fast R\&D prototyping and Kaggle farming
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,366 | 🐛 32 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,105 | 🐛 53 | 🌐 Python | 📅 2026-08-28: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,465 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,016 | 🐛 252 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,292 | 🐛 257 | 🌐 Python | 📅 2026-08-26: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,114 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,465 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,566 | 🐛 2,394 | 🌐 Python | 📅 2026-08-28: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,598 | 🐛 4 | 🌐 Python | 📅 2026-08-28: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,032 | 🐛 126 | 🌐 Python | 📅 2026-08-27: A Python library for learning and evaluating knowledge graph embeddings.
...
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,461 | 🐛 8 | 🌐 Python | 📅 2026-08-24
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,480 | 🐛 248 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
5. [pytorch-template](https://github.com/victoresque/pytorch-template) ⭐ 5,119 | 🐛 23 | 🌐 Python | 📅 2024-06-04: PyTorch template project
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,901 | 🐛 163 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
