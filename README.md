...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,455 | 🐛 2,425 | 🌐 Python | 📅 2026-09-21: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,482 | 🐛 297 | 🌐 Python | 📅 2026-09-20: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
3. [flair](https://github.com/zalandoresearch/flair) ⭐ 14,389 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
4. [AllenNLP](https://github.com/allenai/allennlp) ⚠️ Archived: An open-source NLP research library, built on PyTorch.
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,831 | 🐛 189 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,577 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-09-18: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,174 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,965 | 🐛 100 | 🌐 Python | 📅 2026-09-21: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,944 | 🐛 340 | 🌐 Python | 📅 2026-09-20: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,718 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,944 | 🐛 1,963 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,921 | 🐛 1,223 | 🌐 Python | 📅 2026-09-20: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,368 | 🐛 187 | 🌐 Python | 📅 2026-09-20: Differentiable computer vision library.
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,907 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,057 | 🐛 292 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,883 | 🐛 3,610 | 🌐 Python | 📅 2026-09-21: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,356 | 🐛 1,087 | 🌐 Python | 📅 2026-09-17: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,182 | 🐛 270 | 🌐 Jupyter Notebook | 📅 2026-09-21: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,096 | 🐛 1,341 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,368 | 🐛 187 | 🌐 Python | 📅 2026-09-20: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,876 | 🐛 133 | 🌐 Python | 📅 2026-09-21 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
36. [Ax](https://github.com/facebook/Ax) ⭐ 2,805 | 🐛 186 | 🌐 Python | 📅 2026-09-18: Adaptive Experimentation Platform
37. [PyTorch/XLA](https://github.com/pytorch/xla) ⭐ 2,802 | 🐛 884 | 🌐 C++ | 📅 2026-05-27: PyTorch/XLA is a Python package that uses the XLA deep learning compiler to connect the PyTorch deep learning framework and Cloud TPUs.
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,823 | 🐛 38 | 🌐 Python | 📅 2026-09-21: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
57. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-20: Python library for Reinforcement Learning experiments.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,477 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
...
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,047 | 🐛 254 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,340 | 🐛 262 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
9. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 5,557 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,455 | 🐛 2,425 | 🌐 Python | 📅 2026-09-21: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
17. [StarGAN](https://github.com/yunjey/StarGAN) ⭐ 5,294 | 🐛 67 | 🌐 Python | 📅 2021-01-23: StarGAN: Unified Generative Adversarial Networks for Multi-Domain Image-to-Image Tranlsation.
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,036 | 🐛 130 | 🌐 Python | 📅 2026-09-20: A Python library for learning and evaluating knowledge graph embeddings.
