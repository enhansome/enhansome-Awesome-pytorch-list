...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,702 | 🐛 75 | 🌐 Python | 📅 2026-09-13: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,284 | 🐛 2,414 | 🌐 Python | 📅 2026-09-18: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,472 | 🐛 318 | 🌐 Python | 📅 2026-09-18: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
3. [flair](https://github.com/zalandoresearch/flair) ⭐ 14,388 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
4. [AllenNLP](https://github.com/allenai/allennlp) ⚠️ Archived: An open-source NLP research library, built on PyTorch.
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,823 | 🐛 188 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,564 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2026-09-15: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,173 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,965 | 🐛 70 | 🌐 Python | 📅 2026-09-18: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,939 | 🐛 340 | 🌐 Python | 📅 2026-09-17: simple audio I/O for pytorch.
...
28. [pytorch-struct](https://github.com/harvardnlp/pytorch-struct) ⭐ 1,134 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2022-04-20: A library of vectorized implementations of core structured prediction algorithms (HMM, Dep Trees, CKY, ..,)
...
30. [pytorch-wavenet](https://github.com/vincentherrmann/pytorch-wavenet) ⭐ 1,029 | 🐛 30 | 🌐 Jupyter Notebook | 📅 2020-09-17: An implementation of WaveNet with fast generation
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,713 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,936 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,917 | 🐛 1,222 | 🌐 Python | 📅 2026-09-17: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,363 | 🐛 197 | 🌐 Python | 📅 2026-09-18: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,969 | 🐛 312 | 🌐 Python | 📅 2026-09-15: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,953 | 🐛 870 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,903 | 🐛 331 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,466 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,527 | 🐛 658 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,812 | 🐛 108 | 🌐 Python | 📅 2026-09-14 - Lightly is a computer vision framework for self-supervised learning.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,055 | 🐛 291 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,599 | 🐛 93 | 🌐 Jupyter Notebook | 📅 2026-09-08: Bayesian optimization in PyTorch
...
7. [paysage](https://github.com/drckf/paysage) ⭐ 119 | 🐛 16 | 🌐 Python | 📅 2022-11-21: Unsupervised learning and generative models in python/pytorch.
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,865 | 🐛 3,595 | 🌐 Python | 📅 2026-09-18: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,349 | 🐛 1,083 | 🌐 Python | 📅 2026-09-17: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,174 | 🐛 270 | 🌐 Jupyter Notebook | 📅 2026-09-14: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,089 | 🐛 1,337 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,363 | 🐛 197 | 🌐 Python | 📅 2026-09-18: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,870 | 🐛 105 | 🌐 Python | 📅 2026-09-14 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,999 | 🐛 770 | 🌐 Python | 📅 2026-09-14: An Experimental PyTorch Extension(will be deprecated at a later point)
...
12. [PyTorch-VAE](https://github.com/AntixK/PyTorch-VAE) ⭐ 7,673 | 🐛 68 | 🌐 Python | 📅 2025-03-21: A Collection of Variational Autoencoders (VAE) in PyTorch.
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,174 | 🐛 29 | 🌐 Python | 📅 2026-09-09: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,786 | 🐛 186 | 🌐 Python | 📅 2026-09-09: Ignite is a high-level library to help with training neural networks in PyTorch.
...
21. [simple-faster-rcnn-pytorch](https://github.com/chenyuntc/simple-faster-rcnn-pytorch) ⭐ 4,028 | 🐛 180 | 🌐 Jupyter Notebook | 📅 2021-05-15: A simplified implemention of Faster R-CNN with competitive performance.
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,911 | 🐛 422 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,911 | 🐛 422 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,195 | 🐛 138 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
30. [pytorch-optimizer](https://github.com/jettify/pytorch-optimizer) ⭐ 3,171 | 🐛 57 | 🌐 Python | 📅 2024-03-22: Collections of modern optimization algorithms for PyTorch, includes: AccSGD, AdaBound, AdaMod, DiffGrad, Lamb, RAdam, RAdam, Yogi.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,801 | 🐛 188 | 🌐 Python | 📅 2026-09-15: Adaptive Experimentation Platform
38. [RepDistiller](https://github.com/HobbitLong/RepDistiller) ⭐ 2,442 | 🐛 34 | 🌐 Python | 📅 2023-10-16: Contrastive Representation Distillation (CRD), and benchmark of recent knowledge distillation methods
39. [rlpyt](https://github.com/astooke/rlpyt) ⭐ 2,277 | 🐛 63 | 🌐 Python | 📅 2021-01-04: Reinforcement Learning in PyTorch
40. [cvxpylayers](https://github.com/cvxgrp/cvxpylayers) ⭐ 2,137 | 🐛 30 | 🌐 Python | 📅 2026-09-16: cvxpylayers is a Python library for constructing differentiable convex optimization layers in PyTorch
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,823 | 🐛 36 | 🌐 Python | 📅 2026-09-18: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
57. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-18: Python library for Reinforcement Learning experiments.
...
77. [torchani](https://github.com/aiqm/torchani) ⭐ 560 | 🐛 8 | 🌐 Python | 📅 2026-09-06: Accurate Neural Network Potential on PyTorch aiqm.github.io/torchani
...
86. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 475 | 🐛 1 | 🌐 Python | 📅 2026-09-18: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,458 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,155 | 🐛 53 | 🌐 Python | 📅 2026-09-17: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,045 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,334 | 🐛 259 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
6. **[PyTorch-Tutorial](https://github.com/MorvanZhou/PyTorch-Tutorial) ⭐ 8,469 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2023-03-23**: Build your neural network easy and fast  <https://morvanzhou.github.io/tutorials/>
7. [Run your PyTorch Example Fedarated with Flower](https://github.com/adap/flower/tree/main/examples/pytorch_from_centralized_to_federated) ⭐ 7,135 | 🐛 397 | 🌐 Python | 📅 2026-09-18: This example demonstrates how an already existing centralized PyTorch machine learning project can be federated with Flower. A Cifar-10 dataset is used together with a convolutional neural network (CNN).
...
11. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,453 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
12. [d2l-pytorch](https://github.com/dsgiitr/d2l-pytorch) ⭐ 4,366 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-07-25: This is an attempt to modify Dive into Deep Learning, Berkeley STAT 157 (Spring 2019) textbook's code into PyTorch.
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,284 | 🐛 2,414 | 🌐 Python | 📅 2026-09-18: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,247 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,976 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,609 | 🐛 4 | 🌐 Python | 📅 2026-09-10: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,796 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
8. [vid2vid](https://github.com/NVIDIA/vid2vid) ⭐ 8,693 | 🐛 111 | 🌐 Python | 📅 2022-05-17: Pytorch implementation of our method for high-resolution (e.g. 2048x1024) photorealistic video-to-video translation.
...
14. [Deep-Reinforcement-Learning-Algorithms-with-PyTorch](https://github.com/p-christ/Deep-Reinforcement-Learning-Algorithms-with-PyTorch) ⭐ 5,938 | 🐛 48 | 🌐 Python | 📅 2024-07-25: This repository contains PyTorch implementations of deep reinforcement learning algorithms.
15. [Deep-Reinforcement-Learning-Algorithms-with-PyTorch](https://github.com/p-christ/Deep-Reinforcement-Learning-Algorithms-with-PyTorch) ⭐ 5,938 | 🐛 48 | 🌐 Python | 📅 2024-07-25: PyTorch implementations of deep reinforcement learning algorithms and environments.
...
18. [tacotron2](https://github.com/NVIDIA/tacotron2) ⭐ 5,293 | 🐛 219 | 🌐 Jupyter Notebook | 📅 2024-06-12: Tacotron 2 - PyTorch implementation with faster-than-realtime inference.
19. [Single Shot MultiBox Detector](https://github.com/amdegroot/ssd.pytorch) ⭐ 5,223 | 🐛 380 | 🌐 Python | 📅 2021-12-29: A PyTorch Implementation of Single Shot MultiBox Detector.
...
25. [pytorch - fid](https://github.com/mseitzer/pytorch-fid) ⭐ 3,850 | 🐛 27 | 🌐 Python | 📅 2024-07-03: A Port of Fréchet Inception Distance (FID score) to PyTorch
...
36. [DeblurGAN](https://github.com/KupynOrest/DeblurGAN) ⭐ 2,640 | 🐛 148 | 🌐 Python | 📅 2019-12-25: Pytorch implementation of the paper DeblurGAN: Blind Motion Deblurring Using Conditional Adversarial Networks.
37. [pytorch-generative-model-collections](https://github.com/znxlwm/pytorch-generative-model-collections) ⭐ 2,628 | 🐛 27 | 🌐 Python | 📅 2020-04-12:  Collection of generative models in Pytorch version.
38. [EDSR-PyTorch](https://github.com/thstkdgus35/EDSR-PyTorch) ⭐ 2,628 | 🐛 142 | 🌐 Python | 📅 2023-01-03: PyTorch version of the paper 'Enhanced Deep Residual Networks for Single Image Super-Resolution' (CVPRW 2017)
39. [pointnet.pytorch](https://github.com/fxia22/pointnet.pytorch) ⭐ 2,357 | 🐛 59 | 🌐 Python | 📅 2023-03-23: pytorch implementation for "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" <https://arxiv.org/abs/1612.00593>
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,036 | 🐛 129 | 🌐 Python | 📅 2026-09-06: A Python library for learning and evaluating knowledge graph embeddings.
...
55. [pytorch-openai-transformer-lm](https://github.com/huggingface/pytorch-openai-transformer-lm) ⚠️ Archived: This is a PyTorch implementation of the TensorFlow code provided with OpenAI's paper "Improving Language Understanding by Generative Pre-Training" by Alec Radford, Karthik Narasimhan, Tim Salimans and Ilya Sutskever.
...
78. [torchMoji](https://github.com/huggingface/torchMoji) ⚠️ Archived: A pyTorch implementation of the DeepMoji model: state-of-the-art deep learning model for analyzing sentiment, emotion, sarcasm etc.
...
93. [qp solver](https://github.com/locuslab/qpth) ⭐ 802 | 🐛 17 | 🌐 Python | 📅 2024-09-03: A fast and differentiable QP solver for PyTorch. Crafted by Brandon Amos and J. Zico Kolter.
...
99. [vnet.pytorch](https://github.com/mattmacy/vnet.pytorch) ⭐ 759 | 🐛 26 | 🌐 Python | 📅 2018-07-06: A Pytorch implementation for V-Net: Fully Convolutional Neural Networks for Volumetric Medical Image Segmentation.
100. [NCRF](https://github.com/baidu-research/NCRF) ⭐ 759 | 🐛 4 | 🌐 Python | 📅 2023-10-03: Cancer metastasis detection with neural conditional random field (NCRF)
...
114. [optnet](https://github.com/locuslab/optnet) ⭐ 594 | 🐛 3 | 🌐 Python | 📅 2020-03-26: This repository is by Brandon Amos and J. Zico Kolter and contains the PyTorch source code to reproduce the experiments in our paper OptNet: Differentiable Optimization as a Layer in Neural Networks.
115. [pytorch-made](https://github.com/karpathy/pytorch-made) ⭐ 594 | 🐛 2 | 🌐 Python | 📅 2018-12-08: MADE (Masked Autoencoder Density Estimation) implementation in PyTorch
...
118. [Neural-IMage-Assessment](https://github.com/kentsyx/Neural-IMage-Assessment) ⭐ 586 | 🐛 24 | 🌐 Python | 📅 2021-11-10: A PyTorch Implementation of Neural IMage Assessment.
...
126. [honk](https://github.com/castorini/honk) ⭐ 528 | 🐛 7 | 🌐 Python | 📅 2023-05-22: PyTorch reimplementation of Google's TensorFlow CNNs for keyword spotting.
127. [pytorch-coviar](https://github.com/chaoyuaw/pytorch-coviar) ⭐ 526 | 🐛 56 | 🌐 Python | 📅 2018-07-06: Compressed Video Action Recognition
...
144. [Shufflenet-v2-Pytorch](https://github.com/ericsun99/Shufflenet-v2-Pytorch) ⭐ 436 | 🐛 13 | 🌐 Python | 📅 2019-04-09: This is a Pytorch implementation of faceplusplus's ShuffleNet-v2.
...
173. [pytorch-explain-black-box](https://github.com/jacobgil/pytorch-explain-black-box) ⭐ 336 | 🐛 5 | 🌐 Python | 📅 2021-11-30: PyTorch implementation of Interpretable Explanations of Black Boxes by Meaningful Perturbation
...
198. [SGCN](https://github.com/benedekrozemberczki/SGCN) ⭐ 278 | 🐛 1 | 🌐 Python | 📅 2023-03-18: This is a Pytorch implementation of Signed Graph Convolutional Network. ICDM 2018.
199. [GAM](https://github.com/benedekrozemberczki/GAM) ⭐ 276 | 🐛 4 | 🌐 Python | 📅 2022-11-06: This is a Pytorch implementation of Graph Classification using Structural Attention. KDD 2018.
...
233. [deep-forecast-pytorch](https://github.com/Wizaron/deep-forecast-pytorch) ⭐ 197 | 🐛 0 | 🌐 Python | 📅 2018-01-14: Wind Speed Prediction using LSTMs in PyTorch (arxiv.org/pdf/1707.08110.pdf)
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,644 | 🐛 3 | 📅 2026-07-22**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,466 | 🐛 10 | 🌐 Python | 📅 2026-09-18
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,489 | 🐛 248 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
5. [pytorch-template](https://github.com/victoresque/pytorch-template) ⭐ 5,119 | 🐛 23 | 🌐 Python | 📅 2024-06-04: PyTorch template project
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,911 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
7. [AlphaZero\_Gomoku](https://github.com/junxiaosong/AlphaZero_Gomoku) ⭐ 3,631 | 🐛 80 | 🌐 Python | 📅 2024-04-24: An implementation of the AlphaZero algorithm for Gomoku (also called Gobang or Five in a Row)
