...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,703 | 🐛 76 | 🌐 Python | 📅 2026-09-13: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,556 | 🐛 2,403 | 🌐 Python | 📅 2026-09-23: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,490 | 🐛 301 | 🌐 Python | 📅 2026-09-23: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,836 | 🐛 189 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,587 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2026-09-22: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,172 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,966 | 🐛 103 | 🌐 Python | 📅 2026-09-22: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,943 | 🐛 340 | 🌐 Python | 📅 2026-09-22: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,726 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,953 | 🐛 1,963 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,927 | 🐛 1,224 | 🌐 Python | 📅 2026-09-22: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,378 | 🐛 175 | 🌐 Python | 📅 2026-09-23: Differentiable computer vision library.
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,919 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,469 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,534 | 🐛 658 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,162 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,058 | 🐛 293 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,601 | 🐛 95 | 🌐 Jupyter Notebook | 📅 2026-09-08: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,908 | 🐛 3,600 | 🌐 Python | 📅 2026-09-23: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,358 | 🐛 1,084 | 🌐 Python | 📅 2026-09-21: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,189 | 🐛 271 | 🌐 Jupyter Notebook | 📅 2026-09-21: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,096 | 🐛 1,345 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,378 | 🐛 175 | 🌐 Python | 📅 2026-09-23: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,883 | 🐛 141 | 🌐 Python | 📅 2026-09-21 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 9,002 | 🐛 770 | 🌐 Python | 📅 2026-09-21: An Experimental PyTorch Extension(will be deprecated at a later point)
...
15. [inferno-sklearn](https://github.com/dnouri/inferno) ⭐ 6,179 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-22: A scikit-learn compatible neural network library that wraps pytorch.
16. [skorch](https://github.com/dnouri/skorch) ⭐ 6,179 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-22: A scikit-learn compatible neural network library that wraps pytorch
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,175 | 🐛 29 | 🌐 Python | 📅 2026-09-18: PyTorch library aimed at accelerating 3D deep learning research
...
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,916 | 🐛 424 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,916 | 🐛 424 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,822 | 🐛 36 | 🌐 Python | 📅 2026-09-23: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,497 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,172 | 🐛 55 | 🌐 Python | 📅 2026-09-22: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,501 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
...
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,344 | 🐛 263 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
6. **[PyTorch-Tutorial](https://github.com/MorvanZhou/PyTorch-Tutorial) ⭐ 8,471 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2023-03-23**: Build your neural network easy and fast  <https://morvanzhou.github.io/tutorials/>
7. [Run your PyTorch Example Fedarated with Flower](https://github.com/adap/flower/tree/main/examples/pytorch_from_centralized_to_federated) ⭐ 7,141 | 🐛 388 | 🌐 Python | 📅 2026-09-23: This example demonstrates how an already existing centralized PyTorch machine learning project can be federated with Flower. A Cifar-10 dataset is used together with a convolutional neural network (CNN).
...
9. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 5,644 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,138 | 🐛 6 | 🌐 C++ | 📅 2026-09-13: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,501 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,556 | 🐛 2,403 | 🌐 Python | 📅 2026-09-23: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,250 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
3. [PyTorch-GAN](https://github.com/eriklindernoren/PyTorch-GAN) ⭐ 17,455 | 🐛 142 | 🌐 Python | 📅 2024-06-18: PyTorch implementations of Generative Adversarial Networks.
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,610 | 🐛 4 | 🌐 Python | 📅 2026-09-10: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,799 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
...
41. [deepspeech2](https://github.com/SeanNaren/deepspeech.pytorch) ⭐ 2,135 | 🐛 5 | 🌐 Python | 📅 2022-12-13: Implementation of DeepSpeech2 using Baidu Warp-CTC. Creates a network based on the DeepSpeech2 architecture, trained with the CTC activation function.
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,038 | 🐛 127 | 🌐 Python | 📅 2026-09-22: A Python library for learning and evaluating knowledge graph embeddings.
...
48. [faster rcnn](https://github.com/longcw/faster_rcnn_pytorch) ⭐ 1,777 | 🐛 71 | 🌐 Python | 📅 2021-09-25: This is a PyTorch implementation of Faster RCNN. This project is mainly based on py-faster-rcnn and TFFRCNN.For details about R-CNN please refer to the paper Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks by Shaoqing Ren, Kaiming He, Ross Girshick, Jian Sun.
...
128. [vsepp](https://github.com/fartashf/vsepp) ⭐ 523 | 🐛 0 | 🌐 Python | 📅 2021-12-08: Code for the paper "VSE++: Improved Visual Semantic Embeddings"
...
162. [TuckER](https://github.com/ibalazevic/TuckER) ⭐ 371 | 🐛 2 | 🌐 Python | 📅 2023-11-16: TuckER: Tensor Factorization for Knowledge Graph Completion.
...
255. [pytorch-seq2seq-intent-parsing](https://github.com/spro/pytorch-seq2seq-intent-parsing) ⭐ 157 | 🐛 5 | 🌐 Python | 📅 2017-06-08: Intent parsing and slot filling in PyTorch with seq2seq + attention
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,648 | 🐛 3 | 📅 2026-09-23**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,492 | 🐛 248 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
