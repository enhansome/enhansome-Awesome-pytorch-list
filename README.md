...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,981 | 🐛 2,403 | 🌐 Python | 📅 2026-09-08: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,405 | 🐛 312 | 🌐 Python | 📅 2026-09-07: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,807 | 🐛 182 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,518 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-09-07: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,171 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,949 | 🐛 55 | 🌐 Python | 📅 2026-09-07: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,934 | 🐛 340 | 🌐 Python | 📅 2026-09-07: simple audio I/O for pytorch.
...
30. [pytorch-wavenet](https://github.com/vincentherrmann/pytorch-wavenet) ⭐ 1,031 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2020-09-17: An implementation of WaveNet with fast generation
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,703 | 🐛 590 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,913 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,899 | 🐛 1,219 | 🌐 Python | 📅 2026-09-07: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,347 | 🐛 161 | 🌐 Python | 📅 2026-09-08: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,966 | 🐛 312 | 🌐 Python | 📅 2026-09-03: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,885 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
13. [facenet-pytorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,165 | 🐛 85 | 🌐 Python | 📅 2025-09-16: Pretrained Pytorch face detection and recognition models ported from davidsandberg/facenet.
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,152 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
15. [Augmentor](https://github.com/mdbloice/Augmentor) ⭐ 5,131 | 🐛 139 | 🌐 Python | 📅 2024-03-21: Image augmentation library in Python for machine learning. <http://augmentor.readthedocs.io>
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,802 | 🐛 106 | 🌐 Python | 📅 2026-09-01 - Lightly is a computer vision framework for self-supervised learning.
17. [image-classification-mobile](https://github.com/osmr/imgclsmob) ⭐ 3,015 | 🐛 14 | 🌐 Python | 📅 2024-09-06: Collection of classification models pretrained on the ImageNet-1K.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,046 | 🐛 286 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,591 | 🐛 94 | 🌐 Jupyter Notebook | 📅 2026-09-03: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,737 | 🐛 3,574 | 🌐 Python | 📅 2026-09-08: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,323 | 🐛 1,082 | 🌐 Python | 📅 2026-09-07: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,132 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-09-07: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,069 | 🐛 1,327 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,347 | 🐛 161 | 🌐 Python | 📅 2026-09-08: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,851 | 🐛 82 | 🌐 Python | 📅 2026-09-07 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
15. [inferno-sklearn](https://github.com/dnouri/inferno) ⭐ 6,179 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-08-27: A scikit-learn compatible neural network library that wraps pytorch.
16. [skorch](https://github.com/dnouri/skorch) ⭐ 6,179 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-08-27: A scikit-learn compatible neural network library that wraps pytorch
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,168 | 🐛 28 | 🌐 Python | 📅 2026-09-03: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,783 | 🐛 186 | 🌐 Python | 📅 2026-09-06: Ignite is a high-level library to help with training neural networks in PyTorch.
...
21. [simple-faster-rcnn-pytorch](https://github.com/chenyuntc/simple-faster-rcnn-pytorch) ⭐ 4,027 | 🐛 181 | 🌐 Jupyter Notebook | 📅 2021-05-15: A simplified implemention of Faster R-CNN with competitive performance.
...
25. [PyTorch-StudioGAN](https://github.com/POSTECH-CVLab/PyTorch-StudioGAN) ⭐ 3,487 | 🐛 40 | 🌐 Python | 📅 2024-08-09: StudioGAN is a Pytorch library providing implementations of representative Generative Adversarial Networks (GANs) for conditional/unconditional image generation. StudioGAN aims to offer an identical playground for modern GANs so that machine learning researchers can readily compare and analyze a new idea.
...
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,182 | 🐛 138 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,798 | 🐛 186 | 🌐 Python | 📅 2026-09-03: Adaptive Experimentation Platform
...
40. [cvxpylayers](https://github.com/cvxgrp/cvxpylayers) ⭐ 2,130 | 🐛 25 | 🌐 Python | 📅 2026-05-19: cvxpylayers is a Python library for constructing differentiable convex optimization layers in PyTorch
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,824 | 🐛 37 | 🌐 Python | 📅 2026-09-08: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
46. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,697 | 🐛 9 | 🌐 Python | 📅 2026-09-07: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
57. [geoopt](https://github.com/ferrine/geoopt) ⭐ 1,096 | 🐛 38 | 🌐 Python | 📅 2026-05-09: Riemannian Adaptive Optimization Methods with pytorch optim
...
87. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 474 | 🐛 7 | 🌐 Python | 📅 2026-09-03: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,399 | 🐛 32 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,133 | 🐛 60 | 🌐 Python | 📅 2026-09-06: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,032 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,319 | 🐛 257 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,160 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,981 | 🐛 2,403 | 🌐 Python | 📅 2026-09-08: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,966 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
20. [semantic-segmentation-pytorch](https://github.com/hangzhaomit/semantic-segmentation-pytorch) ⭐ 5,081 | 🐛 82 | 🌐 Python | 📅 2024-01-15: Pytorch implementation for Semantic Segmentation/Scene Parsing on [MIT ADE20K dataset](http://sceneparsing.csail.mit.edu)
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,554 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
22. [Person-reID\_pytorch](https://github.com/layumi/Person_reID_baseline_pytorch) ⭐ 4,448 | 🐛 174 | 🌐 Python | 📅 2026-08-30: PyTorch for Person re-ID.
...
35. **[pytorch-playground](https://github.com/aaron-xichen/pytorch-playground) ⭐ 2,718 | 🐛 11 | 🌐 Python | 📅 2022-11-22: Base pretrained models and datasets in pytorch (MNIST, SVHN, CIFAR10, CIFAR100, STL10, AlexNet, VGG16, VGG19, ResNet, Inception, SqueezeNet)**.
...
39. [pointnet.pytorch](https://github.com/fxia22/pointnet.pytorch) ⭐ 2,354 | 🐛 59 | 🌐 Python | 📅 2023-03-23: pytorch implementation for "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" <https://arxiv.org/abs/1612.00593>
...
73. [gpt-2-Pytorch](https://github.com/graykode/gpt-2-Pytorch) ⭐ 1,013 | 🐛 18 | 🌐 Python | 📅 2019-07-08: Simple Text-Generator with OpenAI gpt-2 Pytorch Implementation
...
91. [SimGNN](https://github.com/benedekrozemberczki/SimGNN) ⭐ 814 | 🐛 9 | 🌐 Python | 📅 2023-01-12: SimGNN: A Neural Network Approach to Fast Graph Similarity Computation.
...
104. [sphereface\_pytorch](https://github.com/clcarwin/sphereface_pytorch) ⭐ 714 | 🐛 35 | 🌐 Python | 📅 2022-02-01: A PyTorch Implementation of SphereFace.
...
111. [pytorch-pose-hg-3d](https://github.com/xingyizhou/pytorch-pose-hg-3d) ⭐ 609 | 🐛 36 | 🌐 Python | 📅 2023-06-21: PyTorch implementation for 3D human pose estimation
...
115. [optnet](https://github.com/locuslab/optnet) ⭐ 592 | 🐛 3 | 🌐 Python | 📅 2020-03-26: This repository is by Brandon Amos and J. Zico Kolter and contains the PyTorch source code to reproduce the experiments in our paper OptNet: Differentiable Optimization as a Layer in Neural Networks.
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,639 | 🐛 3 | 📅 2026-07-22**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,462 | 🐛 9 | 🌐 Python | 📅 2026-09-07
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,484 | 🐛 249 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
...
11. [hasktorch](https://github.com/hasktorch/hasktorch) ⭐ 1,213 | 🐛 89 | 🌐 Haskell | 📅 2026-08-19: Tensors and neural networks in Haskell
12. [pytorch\_misc](https://github.com/ptrblck/pytorch_misc) ⭐ 572 | 🐛 8 | 🌐 Python | 📅 2021-02-19: Code snippets created for the PyTorch discussion board.
