...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,704 | 🐛 76 | 🌐 Python | 📅 2026-09-24: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,585 | 🐛 2,391 | 🌐 Python | 📅 2026-09-24: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,497 | 🐛 300 | 🌐 Python | 📅 2026-09-23: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,839 | 🐛 189 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,591 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2026-09-22: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,172 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,967 | 🐛 102 | 🌐 Python | 📅 2026-09-24: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,944 | 🐛 340 | 🌐 Python | 📅 2026-09-23: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,729 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,954 | 🐛 1,963 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,926 | 🐛 1,225 | 🌐 Python | 📅 2026-09-23: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,378 | 🐛 195 | 🌐 Python | 📅 2026-09-24: Differentiable computer vision library.
...
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,957 | 🐛 870 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,921 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,538 | 🐛 658 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,601 | 🐛 94 | 🌐 Jupyter Notebook | 📅 2026-09-23: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,913 | 🐛 3,618 | 🌐 Python | 📅 2026-09-24: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,360 | 🐛 1,088 | 🌐 Python | 📅 2026-09-21: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,192 | 🐛 271 | 🌐 Jupyter Notebook | 📅 2026-09-21: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,097 | 🐛 1,346 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,378 | 🐛 195 | 🌐 Python | 📅 2026-09-24: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,885 | 🐛 142 | 🌐 Python | 📅 2026-09-23 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 9,002 | 🐛 774 | 🌐 Python | 📅 2026-09-23: An Experimental PyTorch Extension(will be deprecated at a later point)
...
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,917 | 🐛 424 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,917 | 🐛 424 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
36. [Ax](https://github.com/facebook/Ax) ⭐ 2,809 | 🐛 185 | 🌐 Python | 📅 2026-09-21: Adaptive Experimentation Platform
...
57. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 943 | 🐛 4 | 🌐 Python | 📅 2026-09-24: Python library for Reinforcement Learning experiments.
...
108. [mctorch](https://github.com/mctorch/mctorch) ⭐ 257 | 🐛 10 | 🌐 Python | 📅 2021-08-10: A manifold optimization library for deep learning.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,501 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,172 | 🐛 46 | 🌐 Python | 📅 2026-09-23: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,498 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,051 | 🐛 254 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
...
9. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 5,667 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,138 | 🐛 6 | 🌐 C++ | 📅 2026-09-13: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,498 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
36. [pytorch mini tutorials](https://github.com/vinhkhuc/PyTorch-Mini-Tutorials) ⭐ 331 | 🐛 4 | 🌐 Python | 📅 2020-09-16:  Minimal tutorials for PyTorch adapted from Alec Radford's Theano tutorials.
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,585 | 🐛 2,391 | 🌐 Python | 📅 2026-09-24: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,982 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,038 | 🐛 125 | 🌐 Python | 📅 2026-09-23: A Python library for learning and evaluating knowledge graph embeddings.
...
48. [faster rcnn](https://github.com/longcw/faster_rcnn_pytorch) ⭐ 1,778 | 🐛 71 | 🌐 Python | 📅 2021-09-25: This is a PyTorch implementation of Faster RCNN. This project is mainly based on py-faster-rcnn and TFFRCNN.For details about R-CNN please refer to the paper Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks by Shaoqing Ren, Kaiming He, Ross Girshick, Jian Sun.
...
155. [ARAE](https://github.com/jakezhaojb/ARAE) ⭐ 399 | 🐛 18 | 🌐 Python | 📅 2020-04-11: Code for the paper "Adversarially Regularized Autoencoders for Generating Discrete Structures" by Zhao, Kim, Zhang, Rush and LeCun.
156. [DrQA](https://github.com/hitvoice/DrQA) ⭐ 399 | 🐛 9 | 🌐 Python | 📅 2022-03-26: A pytorch implementation of Reading Wikipedia to Answer Open-Domain Questions.
...
189. [universal-triggers](https://github.com/Eric-Wallace/universal-triggers) ⭐ 299 | 🐛 3 | 🌐 Python | 📅 2024-07-25: Universal Adversarial Triggers for Attacking and Analyzing NLP (EMNLP 2019)
...
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,914 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
