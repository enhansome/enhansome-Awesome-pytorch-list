...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,697 | 🐛 73 | 🌐 Python | 📅 2026-09-03: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,772 | 🐛 2,389 | 🌐 Python | 📅 2026-09-04: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,385 | 🐛 303 | 🌐 Python | 📅 2026-09-04: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
3. [flair](https://github.com/zalandoresearch/flair) ⭐ 14,384 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
...
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,508 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-09-02: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,933 | 🐛 340 | 🌐 Python | 📅 2026-09-03: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,700 | 🐛 588 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,906 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,898 | 🐛 1,204 | 🌐 Python | 📅 2026-09-03: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,343 | 🐛 126 | 🌐 Python | 📅 2026-09-04: Differentiable computer vision library.
...
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,939 | 🐛 869 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,871 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,459 | 🐛 69 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,700 | 🐛 3,564 | 🌐 Python | 📅 2026-09-04: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,318 | 🐛 1,078 | 🌐 Python | 📅 2026-09-01: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,130 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2026-09-03: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,061 | 🐛 1,321 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,343 | 🐛 126 | 🌐 Python | 📅 2026-09-04: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,846 | 🐛 118 | 🌐 Python | 📅 2026-09-03 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,164 | 🐛 29 | 🌐 Python | 📅 2026-09-03: PyTorch library aimed at accelerating 3D deep learning research
...
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,907 | 🐛 417 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,907 | 🐛 417 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,824 | 🐛 38 | 🌐 Python | 📅 2026-09-04: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
58. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-03: Python library for Reinforcement Learning experiments.
...
78. [torchani](https://github.com/aiqm/torchani) ⭐ 556 | 🐛 8 | 🌐 Python | 📅 2026-09-04: Accurate Neural Network Potential on PyTorch aiqm.github.io/torchani
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,387 | 🐛 36 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,125 | 🐛 55 | 🌐 Python | 📅 2026-09-01: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,479 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,030 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,315 | 🐛 257 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,137 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,138 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,479 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,772 | 🐛 2,389 | 🌐 Python | 📅 2026-09-04: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
16. [pygcn](https://github.com/tkipf/pygcn) ⭐ 5,396 | 🐛 58 | 🌐 Python | 📅 2020-09-20: Graph Convolutional Networks in PyTorch.
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,552 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,482 | 🐛 249 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
...
8. [ML Workspace](https://github.com/ml-tooling/ml-workspace) ⭐ 3,544 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-07-26: All-in-one web IDE for machine learning and data science. Combines Jupyter, VS Code, PyTorch, and many other tools/libraries into one Docker image.
