...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 165,026 | 🐛 2,397 | 🌐 Python | 📅 2026-09-09: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,409 | 🐛 313 | 🌐 Python | 📅 2026-09-09: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
3. [flair](https://github.com/zalandoresearch/flair) ⭐ 14,385 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
4. [AllenNLP](https://github.com/allenai/allennlp) ⚠️ Archived: An open-source NLP research library, built on PyTorch.
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,810 | 🐛 182 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,522 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-09: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,170 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,951 | 🐛 53 | 🌐 Python | 📅 2026-09-09: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,935 | 🐛 339 | 🌐 Python | 📅 2026-09-08: simple audio I/O for pytorch.
...
22. [jiant](https://github.com/jsalt18-sentence-repl/jiant) ⭐ 1,673 | 🐛 77 | 🌐 Python | 📅 2023-07-06: The jiant sentence representation learning toolkit.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,704 | 🐛 590 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,916 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,901 | 🐛 1,221 | 🌐 Python | 📅 2026-09-08: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,348 | 🐛 156 | 🌐 Python | 📅 2026-09-08: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,965 | 🐛 312 | 🌐 Python | 📅 2026-09-03: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,943 | 🐛 869 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,887 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,461 | 🐛 69 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
13. [facenet-pytorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,166 | 🐛 85 | 🌐 Python | 📅 2025-09-16: Pretrained Pytorch face detection and recognition models ported from davidsandberg/facenet.
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,156 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,802 | 🐛 105 | 🌐 Python | 📅 2026-09-08 - Lightly is a computer vision framework for self-supervised learning.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,049 | 🐛 286 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,592 | 🐛 93 | 🌐 Jupyter Notebook | 📅 2026-09-08: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,754 | 🐛 3,572 | 🌐 Python | 📅 2026-09-09: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,326 | 🐛 1,085 | 🌐 Python | 📅 2026-09-07: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,133 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-09-09: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,069 | 🐛 1,329 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,348 | 🐛 156 | 🌐 Python | 📅 2026-09-08: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,852 | 🐛 73 | 🌐 Python | 📅 2026-09-08 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,168 | 🐛 28 | 🌐 Python | 📅 2026-09-09: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,783 | 🐛 183 | 🌐 Python | 📅 2026-09-08: Ignite is a high-level library to help with training neural networks in PyTorch.
...
25. [PyTorch-StudioGAN](https://github.com/POSTECH-CVLab/PyTorch-StudioGAN) ⭐ 3,486 | 🐛 40 | 🌐 Python | 📅 2024-08-09: StudioGAN is a Pytorch library providing implementations of representative Generative Adversarial Networks (GANs) for conditional/unconditional image generation. StudioGAN aims to offer an identical playground for modern GANs so that machine learning researchers can readily compare and analyze a new idea.
...
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,184 | 🐛 138 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,799 | 🐛 185 | 🌐 Python | 📅 2026-09-08: Adaptive Experimentation Platform
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,823 | 🐛 37 | 🌐 Python | 📅 2026-09-09: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
46. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,697 | 🐛 8 | 🌐 Python | 📅 2026-09-07: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
51. [torchstat](https://github.com/Swall0w/torchstat) ⭐ 1,499 | 🐛 45 | 🌐 Python | 📅 2023-03-19: Model analyzer in PyTorch.
52. [redner](https://github.com/BachiLi/redner) ⭐ 1,444 | 🐛 53 | 🌐 NASL | 📅 2022-08-19: A differentiable Monte Carlo path tracer
53. [hub](https://github.com/pytorch/hub) ⭐ 1,434 | 🐛 56 | 🌐 Python | 📅 2024-04-15: Pytorch Hub is a pre-trained model repository designed to facilitate research reproducibility.
...
55. [SLM-Lab](https://github.com/kengz/SLM-Lab) ⭐ 1,362 | 🐛 5 | 🌐 Python | 📅 2026-08-20: Modular Deep Reinforcement Learning framework in PyTorch.
56. [extension-cpp](https://github.com/pytorch/extension-cpp) ⭐ 1,202 | 🐛 53 | 🌐 Python | 📅 2026-01-13: C++ extensions in PyTorch
57. [geoopt](https://github.com/ferrine/geoopt) ⭐ 1,097 | 🐛 38 | 🌐 Python | 📅 2026-05-09: Riemannian Adaptive Optimization Methods with pytorch optim
58. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-07: Python library for Reinforcement Learning experiments.
59. [jetson-reinforcement](https://github.com/dusty-nv/jetson-reinforcement) ⭐ 931 | 🐛 30 | 🌐 C++ | 📅 2022-01-27: Deep reinforcement learning libraries for NVIDIA Jetson TX1/TX2 with PyTorch, OpenAI Gym, and Gazebo robotics simulator.
60. [pytorch\_cluster](https://github.com/rusty1s/pytorch_cluster) ⭐ 929 | 🐛 21 | 🌐 C++ | 📅 2026-06-05: PyTorch Extension Library of Optimised Graph Cluster Algorithms.
...
63. [pytorch2keras](https://github.com/nerox8664/pytorch2keras) ⭐ 861 | 🐛 62 | 🌐 Python | 📅 2022-12-08: Convert PyTorch dynamic graph to Keras model.
64. [torchbeast](https://github.com/facebookresearch/torchbeast) ⚠️ Archived: A PyTorch Platform for Distributed RL
65. [OpenChem](https://github.com/Mariewelt/OpenChem) ⭐ 753 | 🐛 17 | 🌐 Python | 📅 2023-11-26: OpenChem: Deep Learning toolkit for Computational Chemistry and Drug Design Research mariewelt.github.io/OpenChem
...
67. [autonomous-learning-library](https://github.com/cpnota/autonomous-learning-library) ⭐ 657 | 🐛 24 | 🌐 Python | 📅 2024-03-17: A PyTorch library for building deep reinforcement learning agents.
...
70. [PyTorch-LBFGS](https://github.com/hjmshi/PyTorch-LBFGS) ⭐ 630 | 🐛 9 | 🌐 Python | 📅 2023-02-21: A PyTorch implementation of L-BFGS.
...
78. [torchani](https://github.com/aiqm/torchani) ⭐ 556 | 🐛 8 | 🌐 Python | 📅 2026-09-06: Accurate Neural Network Potential on PyTorch aiqm.github.io/torchani
79. [convert\_torch\_to\_pytorch](https://github.com/clcarwin/convert_torch_to_pytorch) ⭐ 541 | 🐛 28 | 🌐 Python | 📅 2023-07-10: Convert torch t7 model to pytorch model and source.
80. [pro\_gan\_pytorch](https://github.com/akanimax/pro_gan_pytorch) ⭐ 540 | 🐛 5 | 🌐 Python | 📅 2023-10-03: ProGAN package implemented as an extension of PyTorch nn.Module
81. [wavetorch](https://github.com/fancompute/wavetorch) ⭐ 539 | 🐛 3 | 🌐 Python | 📅 2020-02-08: Numerically solving and backpropagating through the wave equation arxiv.org/abs/1904.12831
...
85. [pixyz](https://github.com/masa-su/pixyz) ⭐ 505 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2025-09-22: a library for developing deep generative models in a more concise, intuitive and extendable way.
...
87. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 474 | 🐛 7 | 🌐 Python | 📅 2026-09-09: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
...
97. [nonechucks](https://github.com/msamogh/nonechucks) ⭐ 377 | 🐛 20 | 🌐 Python | 📅 2022-09-22: Skip bad items in your PyTorch DataLoader, use Transforms as Filters, and more!
...
99. [magnet](https://github.com/MagNet-DL/magnet) ⭐ 359 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2019-01-10: Deep Learning Projects that Build Themselves <http://magnet-dl.readthedocs.io/>
100. [salad](https://github.com/domainadaptation/salad) ⭐ 341 | 🐛 32 | 🌐 HTML | 📅 2021-05-15: Semi-Supervised Learning and Domain Adaptation.
...
109. [mctorch](https://github.com/mctorch/mctorch) ⭐ 256 | 🐛 10 | 🌐 Python | 📅 2021-08-10: A manifold optimization library for deep learning.
110. [inferno](https://github.com/nasimrahaman/inferno) ⚠️ Archived: A utility library around PyTorch
111. [torch-two-sample](https://github.com/josipd/torch-two-sample) ⭐ 245 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2025-11-12: A PyTorch library for two-sample tests
...
113. [PySNN](https://github.com/BasBuller/PySNN) ⭐ 234 | 🐛 4 | 🌐 Python | 📅 2024-07-31: Efficient Spiking Neural Network framework, built on top of PyTorch for GPU acceleration.
...
118. [beauty-net](https://github.com/cms-flash/beauty-net) ⭐ 192 | 🐛 0 | 🌐 Python | 📅 2023-11-07: A simple, flexible, and extensible template for PyTorch. It's beautiful.
...
121. [mpl.pytorch](https://github.com/BelBES/mpl.pytorch) ⭐ 177 | 🐛 4 | 🌐 Python | 📅 2018-06-09: Pytorch implementation of MaxPoolingLoss.
122. [QuCumber](https://github.com/PIQuIL/QuCumber) ⭐ 177 | 🐛 14 | 🌐 Python | 📅 2026-08-21: Neural Network Many-Body Wavefunction Reconstruction
123. [caffe\_to\_torch\_to\_pytorch](https://github.com/fanq15/caffe_to_torch_to_pytorch) ⭐ 150 | 🐛 6 | 🌐 Python | 📅 2017-06-22
124. [Pytorch Geometric Signed Directed](https://github.com/SherylHYX/pytorch_geometric_signed_directed) ⭐ 148 | 🐛 0 | 🌐 Python | 📅 2026-09-03: A signed and directed extension library for PyTorch Geometric.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,403 | 🐛 32 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,134 | 🐛 61 | 🌐 Python | 📅 2026-09-08: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,481 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,035 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,320 | 🐛 258 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,170 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,481 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 165,026 | 🐛 2,397 | 🌐 Python | 📅 2026-09-09: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,237 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,602 | 🐛 4 | 🌐 Python | 📅 2026-09-01: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,787 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
8. [vid2vid](https://github.com/NVIDIA/vid2vid) ⭐ 8,691 | 🐛 110 | 🌐 Python | 📅 2022-05-17: Pytorch implementation of our method for high-resolution (e.g. 2048x1024) photorealistic video-to-video translation.
...
10. [pulse](https://github.com/adamian98/pulse) ⭐ 8,022 | 🐛 61 | 🌐 Python | 📅 2021-04-30: Self-Supervised Photo Upsampling via Latent Space Exploration of Generative Models
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,556 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
...
30. [loss-landscape](https://github.com/tomgoldstein/loss-landscape) ⭐ 3,201 | 🐛 30 | 🌐 Python | 📅 2022-04-05: loss-landscape Code for visualizing the loss landscape of neural nets.
...
39. [pointnet.pytorch](https://github.com/fxia22/pointnet.pytorch) ⭐ 2,353 | 🐛 59 | 🌐 Python | 📅 2023-03-23: pytorch implementation for "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" <https://arxiv.org/abs/1612.00593>
...
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,904 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
...
10. [PyTorch Style Guide](https://github.com/IgorSusmelj/pytorch-styleguide) ⭐ 2,018 | 🐛 9 | 🌐 Python | 📅 2021-12-28 Style guide for PyTorch code. Consistent and good code style helps collaboration and prevents errors!
11. [hasktorch](https://github.com/hasktorch/hasktorch) ⭐ 1,214 | 🐛 89 | 🌐 Haskell | 📅 2026-08-19: Tensors and neural networks in Haskell
