...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,146 | 🐛 2,435 | 🌐 Python | 📅 2026-09-15: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,451 | 🐛 312 | 🌐 Python | 📅 2026-09-15: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,554 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-10: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,171 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,960 | 🐛 58 | 🌐 Python | 📅 2026-09-14: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,938 | 🐛 339 | 🌐 Python | 📅 2026-09-14: simple audio I/O for pytorch.
...
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,911 | 🐛 1,223 | 🌐 Python | 📅 2026-09-15: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,357 | 🐛 167 | 🌐 Python | 📅 2026-09-15: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,968 | 🐛 316 | 🌐 Python | 📅 2026-09-03: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,950 | 🐛 870 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,900 | 🐛 331 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,526 | 🐛 658 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,809 | 🐛 110 | 🌐 Python | 📅 2026-09-14 - Lightly is a computer vision framework for self-supervised learning.
...
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,598 | 🐛 93 | 🌐 Jupyter Notebook | 📅 2026-09-08: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,805 | 🐛 3,616 | 🌐 Python | 📅 2026-09-15: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,343 | 🐛 1,084 | 🌐 Python | 📅 2026-09-14: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,133 | 🐛 270 | 🌐 Jupyter Notebook | 📅 2026-09-14: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,080 | 🐛 1,334 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,357 | 🐛 167 | 🌐 Python | 📅 2026-09-15: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,867 | 🐛 95 | 🌐 Python | 📅 2026-09-14 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
12. [PyTorch-VAE](https://github.com/AntixK/PyTorch-VAE) ⭐ 7,671 | 🐛 68 | 🌐 Python | 📅 2025-03-21: A Collection of Variational Autoencoders (VAE) in PyTorch.
13. [torchdiffeq](https://github.com/rtqichen/torchdiffeq) ⭐ 6,483 | 🐛 96 | 🌐 Python | 📅 2025-04-04: Differentiable ODE solvers with full GPU support and O(1)-memory backpropagation.
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,172 | 🐛 29 | 🌐 Python | 📅 2026-09-09: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,786 | 🐛 185 | 🌐 Python | 📅 2026-09-09: Ignite is a high-level library to help with training neural networks in PyTorch.
...
26. [tensorwatch](https://github.com/microsoft/tensorwatch) ⭐ 3,473 | 🐛 54 | 🌐 Jupyter Notebook | 📅 2026-03-30: Debugging, monitoring and visualization for Deep Learning and Reinforcement Learning from Microsoft Research.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,801 | 🐛 188 | 🌐 Python | 📅 2026-09-14: Adaptive Experimentation Platform
...
40. [cvxpylayers](https://github.com/cvxgrp/cvxpylayers) ⭐ 2,134 | 🐛 28 | 🌐 Python | 📅 2026-05-19: cvxpylayers is a Python library for constructing differentiable convex optimization layers in PyTorch
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,822 | 🐛 39 | 🌐 Python | 📅 2026-09-15: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
77. [torchani](https://github.com/aiqm/torchani) ⭐ 559 | 🐛 8 | 🌐 Python | 📅 2026-09-06: Accurate Neural Network Potential on PyTorch aiqm.github.io/torchani
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,450 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,144 | 🐛 59 | 🌐 Python | 📅 2026-09-14: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,044 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,326 | 🐛 259 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
6. **[PyTorch-Tutorial](https://github.com/MorvanZhou/PyTorch-Tutorial) ⭐ 8,468 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2023-03-23**: Build your neural network easy and fast  <https://morvanzhou.github.io/tutorials/>
7. [Run your PyTorch Example Fedarated with Flower](https://github.com/adap/flower/tree/main/examples/pytorch_from_centralized_to_federated) ⭐ 7,131 | 🐛 387 | 🌐 Python | 📅 2026-09-15: This example demonstrates how an already existing centralized PyTorch machine learning project can be federated with Flower. A Cifar-10 dataset is used together with a convolutional neural network (CNN).
...
11. [d2l-pytorch](https://github.com/dsgiitr/d2l-pytorch) ⭐ 4,364 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-07-25: This is an attempt to modify Dive into Deep Learning, Berkeley STAT 157 (Spring 2019) textbook's code into PyTorch.
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,202 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,146 | 🐛 2,435 | 🌐 Python | 📅 2026-09-15: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,245 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
3. [PyTorch-GAN](https://github.com/eriklindernoren/PyTorch-GAN) ⭐ 17,454 | 🐛 142 | 🌐 Python | 📅 2024-06-18: PyTorch implementations of Generative Adversarial Networks.
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,970 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,606 | 🐛 4 | 🌐 Python | 📅 2026-09-10: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,791 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,561 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
...
39. [pointnet.pytorch](https://github.com/fxia22/pointnet.pytorch) ⭐ 2,356 | 🐛 59 | 🌐 Python | 📅 2023-03-23: pytorch implementation for "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" <https://arxiv.org/abs/1612.00593>
...
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,467 | 🐛 14 | 🌐 Python | 📅 2026-09-13
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,486 | 🐛 248 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
