...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,170 | 🐛 2,382 | 🌐 Python | 📅 2026-08-17: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,146 | 🐛 237 | 🌐 Python | 📅 2026-08-16: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,759 | 🐛 188 | 🌐 Python | 📅 2026-06-15: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,425 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,167 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,924 | 🐛 56 | 🌐 Python | 📅 2026-08-14: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,926 | 🐛 337 | 🌐 Python | 📅 2026-08-16: simple audio I/O for pytorch.
...
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,880 | 🐛 1,960 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,868 | 🐛 1,196 | 🌐 Python | 📅 2026-08-16: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,315 | 🐛 86 | 🌐 Python | 📅 2026-08-16: Differentiable computer vision library.
...
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,918 | 🐛 868 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,832 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,508 | 🐛 654 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,139 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,793 | 🐛 103 | 🌐 Python | 📅 2026-08-16 - Lightly is a computer vision framework for self-supervised learning.
...
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,585 | 🐛 92 | 🌐 Jupyter Notebook | 📅 2026-08-15: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,535 | 🐛 3,487 | 🌐 Python | 📅 2026-08-17: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,288 | 🐛 1,072 | 🌐 Python | 📅 2026-08-09: Rapid research framework for Pytorch. The researcher's version of keras.
...
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,013 | 🐛 1,309 | 🌐 Python | 📅 2026-07-31: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,315 | 🐛 86 | 🌐 Python | 📅 2026-08-16: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,820 | 🐛 111 | 🌐 Python | 📅 2026-08-10 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,991 | 🐛 769 | 🌐 Python | 📅 2026-08-10: An Experimental PyTorch Extension(will be deprecated at a later point)
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,161 | 🐛 31 | 🌐 Python | 📅 2026-08-14: PyTorch library aimed at accelerating 3D deep learning research
...
30. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,163 | 🐛 140 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,825 | 🐛 34 | 🌐 Python | 📅 2026-08-17: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
46. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,696 | 🐛 15 | 🌐 Python | 📅 2026-08-09: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,068 | 🐛 61 | 🌐 Python | 📅 2026-08-11: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,460 | 🐛 90 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
...
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,281 | 🐛 255 | 🌐 Python | 📅 2026-07-31: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,078 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,460 | 🐛 90 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,170 | 🐛 2,382 | 🌐 Python | 📅 2026-08-17: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,952 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,590 | 🐛 4 | 🌐 Python | 📅 2026-08-15: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
...
42. [UNIT](https://github.com/mingyuliutw/UNIT) ⭐ 2,026 | 🐛 5 | 🌐 Python | 📅 2021-09-02: PyTorch Implementation of our Coupled VAE-GAN algorithm for Unsupervised Image-to-Image Translation
43. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,024 | 🐛 133 | 🌐 Python | 📅 2026-08-15: A Python library for learning and evaluating knowledge graph embeddings.
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,621 | 🐛 3 | 📅 2026-07-22**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,456 | 🐛 11 | 🌐 Python | 📅 2026-08-16
...
5. [pytorch-template](https://github.com/victoresque/pytorch-template) ⭐ 5,118 | 🐛 24 | 🌐 Python | 📅 2024-06-04: PyTorch template project
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,896 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
