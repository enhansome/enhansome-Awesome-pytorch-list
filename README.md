...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,711 | 🐛 2,398 | 🌐 Python | 📅 2026-09-02: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,375 | 🐛 313 | 🌐 Python | 📅 2026-09-02: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,499 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-09-02: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,171 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,947 | 🐛 54 | 🌐 Python | 📅 2026-09-02: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,933 | 🐛 338 | 🌐 Python | 📅 2026-09-01: simple audio I/O for pytorch.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,691 | 🐛 588 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,899 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,896 | 🐛 1,202 | 🌐 Python | 📅 2026-09-02: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,340 | 🐛 118 | 🌐 Python | 📅 2026-09-02: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,962 | 🐛 312 | 🌐 Python | 📅 2026-08-27: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,937 | 🐛 869 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,867 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,523 | 🐛 656 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,044 | 🐛 286 | 🌐 Python | 📅 2026-09-01: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,684 | 🐛 3,541 | 🌐 Python | 📅 2026-09-02: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,313 | 🐛 1,076 | 🌐 Python | 📅 2026-09-01: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,130 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2026-08-29: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,052 | 🐛 1,318 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
5. [dgl](https://github.com/dmlc/dgl) ⭐ 14,283 | 🐛 608 | 🌐 Python | 📅 2025-07-31: Python package built to ease deep learning on graph, on top of existing DL frameworks. <http://dgl.ai>.
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,340 | 🐛 118 | 🌐 Python | 📅 2026-09-02: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,840 | 🐛 115 | 🌐 Python | 📅 2026-09-01 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
12. [PyTorch-VAE](https://github.com/AntixK/PyTorch-VAE) ⭐ 7,667 | 🐛 68 | 🌐 Python | 📅 2025-03-21: A Collection of Variational Autoencoders (VAE) in PyTorch.
13. [torchdiffeq](https://github.com/rtqichen/torchdiffeq) ⭐ 6,477 | 🐛 95 | 🌐 Python | 📅 2025-04-04: Differentiable ODE solvers with full GPU support and O(1)-memory backpropagation.
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,163 | 🐛 27 | 🌐 Python | 📅 2026-09-01: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,780 | 🐛 187 | 🌐 Python | 📅 2026-09-01: Ignite is a high-level library to help with training neural networks in PyTorch.
...
24. [pytorchviz](https://github.com/szagoruyko/pytorchviz) ⭐ 3,501 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2024-12-30: A small package to create visualizations of PyTorch execution graphs.
...
33. [MinkowskiEngine](https://github.com/StanfordVL/MinkowskiEngine) ⭐ 2,957 | 🐛 236 | 🌐 Python | 📅 2024-03-05: Minkowski Engine is an auto-diff library for generalized sparse convolutions and high-dimensional sparse tensors.
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,824 | 🐛 28 | 🌐 Python | 📅 2026-09-01: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
46. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,695 | 🐛 12 | 🌐 Python | 📅 2026-09-01: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
58. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 4 | 🌐 Python | 📅 2026-08-28: Python library for Reinforcement Learning experiments.
...
87. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 474 | 🐛 5 | 🌐 Python | 📅 2026-09-01: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
...
124. [Pytorch Geometric Signed Directed](https://github.com/SherylHYX/pytorch_geometric_signed_directed) ⭐ 148 | 🐛 0 | 🌐 Python | 📅 2026-04-15: A signed and directed extension library for PyTorch Geometric.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,389 | 🐛 32 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,119 | 🐛 54 | 🌐 Python | 📅 2026-09-01: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,021 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,307 | 🐛 259 | 🌐 Python | 📅 2026-08-26: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,128 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,711 | 🐛 2,398 | 🌐 Python | 📅 2026-09-02: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,234 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,963 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
5. [FastPhotoStyle](https://github.com/NVIDIA/FastPhotoStyle) ⭐ 11,175 | 🐛 57 | 🌐 Python | 📅 2023-06-07: A Closed-form Solution to Photorealistic Image Stylization
...
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,784 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
...
30. [loss-landscape](https://github.com/tomgoldstein/loss-landscape) ⭐ 3,199 | 🐛 30 | 🌐 Python | 📅 2022-04-05: loss-landscape Code for visualizing the loss landscape of neural nets.
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,033 | 🐛 129 | 🌐 Python | 📅 2026-09-01: A Python library for learning and evaluating knowledge graph embeddings.
...
70. [graphsage-simple](https://github.com/williamleif/graphsage-simple) ⭐ 1,052 | 🐛 20 | 🌐 Python | 📅 2020-05-11: Simple reference implementation of GraphSAGE.
...
115. [optnet](https://github.com/locuslab/optnet) ⭐ 591 | 🐛 3 | 🌐 Python | 📅 2020-03-26: This repository is by Brandon Amos and J. Zico Kolter and contains the PyTorch source code to reproduce the experiments in our paper OptNet: Differentiable Optimization as a Layer in Neural Networks.
...
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,463 | 🐛 8 | 🌐 Python | 📅 2026-09-01
3. [generative models](https://github.com/wiseodd/generative-models) ⭐ 7,490 | 🐛 31 | 🌐 Python | 📅 2024-03-24: Collection of generative models, e.g. GAN, VAE in Tensorflow, Keras, and Pytorch. <http://wiseodd.github.io>
...
7. [AlphaZero\_Gomoku](https://github.com/junxiaosong/AlphaZero_Gomoku) ⭐ 3,627 | 🐛 80 | 🌐 Python | 📅 2024-04-24: An implementation of the AlphaZero algorithm for Gomoku (also called Gobang or Five in a Row)
...
26. [pytorch-inference](https://github.com/zccyman/pytorch-inference) ⭐ 89 | 🐛 1 | 🌐 C++ | 📅 2019-01-17: PyTorch 1.0 inference in C++ on Windows10 platforms.
