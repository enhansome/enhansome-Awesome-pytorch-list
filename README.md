...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,699 | 🐛 72 | 🌐 Python | 📅 2026-09-04: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 165,066 | 🐛 2,415 | 🌐 Python | 📅 2026-09-10: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,413 | 🐛 316 | 🌐 Python | 📅 2026-09-10: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
3. [flair](https://github.com/zalandoresearch/flair) ⭐ 14,386 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
4. [AllenNLP](https://github.com/allenai/allennlp) ⚠️ Archived: An open-source NLP research library, built on PyTorch.
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,812 | 🐛 187 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,530 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-09: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,171 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,952 | 🐛 58 | 🌐 Python | 📅 2026-09-10: End-to-End Speech Processing Toolkit espnet.github.io/espnet
9. [OpenNMT-py](https://github.com/OpenNMT/OpenNMT-py) ⭐ 7,016 | 🐛 23 | 🌐 Python | 📅 2025-10-14: Open-Source Neural Machine Translation in PyTorch <http://opennmt.net>
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,936 | 🐛 339 | 🌐 Python | 📅 2026-09-09: simple audio I/O for pytorch.
17. [neuralcoref](https://github.com/huggingface/neuralcoref) ⭐ 2,892 | 🐛 65 | 🌐 C | 📅 2023-04-13: State-of-the-art coreference resolution based on neural nets and spaCy huggingface.co/coref
...
27. [voicefilter](https://github.com/mindslab-ai/voicefilter) ⭐ 1,219 | 🐛 13 | 🌐 Python | 📅 2024-07-25: Unofficial PyTorch implementation of Google AI's VoiceFilter system <http://swpark.me/voicefilter>
...
29. [sentiment-discovery](https://github.com/NVIDIA/sentiment-discovery) ⭐ 1,065 | 🐛 48 | 🌐 Python | 📅 2020-06-28: Unsupervised Language Modeling at scale for robust sentiment classification.
30. [pytorch-wavenet](https://github.com/vincentherrmann/pytorch-wavenet) ⭐ 1,031 | 🐛 30 | 🌐 Jupyter Notebook | 📅 2020-09-17: An implementation of WaveNet with fast generation
...
42. [torch-metrics](https://github.com/enochkan/torch-metrics) ⭐ 110 | 🐛 3 | 🌐 Python | 📅 2026-09-07: Metrics for model evaluation in pytorch
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,706 | 🐛 590 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,917 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,902 | 🐛 1,221 | 🌐 Python | 📅 2026-09-09: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,350 | 🐛 151 | 🌐 Python | 📅 2026-09-10: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,966 | 🐛 313 | 🌐 Python | 📅 2026-09-03: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,946 | 🐛 869 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,890 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
10. [face-alignment](https://github.com/1adrianb/face-alignment) ⭐ 7,537 | 🐛 91 | 🌐 Python | 📅 2026-04-06: :fire: 2D and 3D Face alignment library build using pytorch adrianbulat.com
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,463 | 🐛 69 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,527 | 🐛 656 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
13. [facenet-pytorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,167 | 🐛 85 | 🌐 Python | 📅 2025-09-16: Pretrained Pytorch face detection and recognition models ported from davidsandberg/facenet.
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,157 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,803 | 🐛 105 | 🌐 Python | 📅 2026-09-08 - Lightly is a computer vision framework for self-supervised learning.
17. [image-classification-mobile](https://github.com/osmr/imgclsmob) ⭐ 3,014 | 🐛 14 | 🌐 Python | 📅 2024-09-06: Collection of classification models pretrained on the ImageNet-1K.
...
22. [s2cnn](https://github.com/jonas-koehler/s2cnn) ⭐ 971 | 🐛 18 | 🌐 Python | 📅 2024-11-11:
...
23. [medicaltorch](https://github.com/perone/medicaltorch) ⭐ 872 | 🐛 17 | 🌐 Python | 📅 2024-04-26: A medical imaging framework for Pytorch <http://medicaltorch.readthedocs.io>
...
25. [FlashTorch](https://github.com/MisaOgura/flashtorch) ⭐ 744 | 🐛 10 | 🌐 HTML | 📅 2023-09-21: Visualization toolkit for neural networks in PyTorch!
...
27. [Lucent](https://github.com/greentfrapp/lucent) ⭐ 665 | 🐛 22 | 🌐 Python | 📅 2025-03-21: Tensorflow and OpenAI Clarity's Lucid adapted for PyTorch.
28. [detecto](https://github.com/alankbi/detecto) ⭐ 626 | 🐛 48 | 🌐 Python | 📅 2024-07-25:Computer vision in Python with less than 10 lines of code
29. [detectorch](https://github.com/ignacio-rocco/detectorch) ⭐ 558 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2018-10-30: Detectorch - detectron for PyTorch
...
35. [neural-dream](https://github.com/ProGamerGov/neural-dream) ⭐ 148 | 🐛 10 | 🌐 Python | 📅 2021-09-29: A PyTorch implementation of the DeepDream algorithm. Creates dream-like hallucinogenic visuals.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,050 | 🐛 287 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,593 | 🐛 93 | 🌐 Jupyter Notebook | 📅 2026-09-08: Bayesian optimization in PyTorch
...
4. [pro\_gan\_pytorch](https://github.com/akanimax/pro_gan_pytorch) ⭐ 540 | 🐛 5 | 🌐 Python | 📅 2023-10-03: ProGAN package implemented as an extension of PyTorch nn.Module.
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,764 | 🐛 3,572 | 🌐 Python | 📅 2026-09-10: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,328 | 🐛 1,089 | 🌐 Python | 📅 2026-09-10: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,133 | 🐛 269 | 🌐 Jupyter Notebook | 📅 2026-09-09: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,073 | 🐛 1,330 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
5. [dgl](https://github.com/dmlc/dgl) ⭐ 14,281 | 🐛 609 | 🌐 Python | 📅 2025-07-31: Python package built to ease deep learning on graph, on top of existing DL frameworks. <http://dgl.ai>.
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,350 | 🐛 151 | 🌐 Python | 📅 2026-09-10: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,853 | 🐛 79 | 🌐 Python | 📅 2026-09-09 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,999 | 🐛 771 | 🌐 Python | 📅 2026-09-07: An Experimental PyTorch Extension(will be deprecated at a later point)
...
11. [tensorboard-pytorch](https://github.com/lanpa/tensorboard-pytorch) ⭐ 7,999 | 🐛 85 | 🌐 Python | 📅 2026-07-14: This module saves PyTorch tensors in tensorboard format for inspection. Currently supports scalar, image, audio, histogram features in tensorboard.
12. [PyTorch-VAE](https://github.com/AntixK/PyTorch-VAE) ⭐ 7,672 | 🐛 68 | 🌐 Python | 📅 2025-03-21: A Collection of Variational Autoencoders (VAE) in PyTorch.
13. [torchdiffeq](https://github.com/rtqichen/torchdiffeq) ⭐ 6,481 | 🐛 95 | 🌐 Python | 📅 2025-04-04: Differentiable ODE solvers with full GPU support and O(1)-memory backpropagation.
14. [pytorch-metric-learning](https://github.com/KevinMusgrave/pytorch-metric-learning) ⭐ 6,340 | 🐛 77 | 🌐 Python | 📅 2025-08-17: The easiest way to use metric learning in your application. Modular, flexible, and extensible. Written in PyTorch.
15. [inferno-sklearn](https://github.com/dnouri/inferno) ⭐ 6,179 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-09-08: A scikit-learn compatible neural network library that wraps pytorch.
16. [skorch](https://github.com/dnouri/skorch) ⭐ 6,179 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-09-08: A scikit-learn compatible neural network library that wraps pytorch
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,170 | 🐛 29 | 🌐 Python | 📅 2026-09-09: PyTorch library aimed at accelerating 3D deep learning research
18. [pytorch-OpCounter](https://github.com/Lyken17/pytorch-OpCounter) ⭐ 5,076 | 🐛 84 | 🌐 Python | 📅 2024-07-08: Count the FLOPs of your PyTorch model.
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,783 | 🐛 182 | 🌐 Python | 📅 2026-09-09: Ignite is a high-level library to help with training neural networks in PyTorch.
20. [pytorch-summary](https://github.com/sksq96/pytorch-summary) ⭐ 4,052 | 🐛 141 | 🌐 Python | 📅 2024-03-02: Model summary in PyTorch similar to `model.summary()` in Keras
21. [simple-faster-rcnn-pytorch](https://github.com/chenyuntc/simple-faster-rcnn-pytorch) ⭐ 4,027 | 🐛 180 | 🌐 Jupyter Notebook | 📅 2021-05-15: A simplified implemention of Faster R-CNN with competitive performance.
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,909 | 🐛 419 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,909 | 🐛 419 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
24. [pytorchviz](https://github.com/szagoruyko/pytorchviz) ⭐ 3,503 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2024-12-30: A small package to create visualizations of PyTorch execution graphs.
...
28. [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,382 | 🐛 5 | 🌐 Python | 📅 2026-07-08: High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,186 | 🐛 138 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
30. [pytorch-optimizer](https://github.com/jettify/pytorch-optimizer) ⭐ 3,170 | 🐛 57 | 🌐 Python | 📅 2024-03-22: Collections of modern optimization algorithms for PyTorch, includes: AccSGD, AdaBound, AdaMod, DiffGrad, Lamb, RAdam, RAdam, Yogi.
...
33. [MinkowskiEngine](https://github.com/StanfordVL/MinkowskiEngine) ⭐ 2,959 | 🐛 236 | 🌐 Python | 📅 2024-03-05: Minkowski Engine is an auto-diff library for generalized sparse convolutions and high-dimensional sparse tensors.
...
35. [learn2learn](https://github.com/learnables/learn2learn) ⭐ 2,893 | 🐛 34 | 🌐 Python | 📅 2025-12-16: PyTorch Meta-learning Framework for Researchers <http://learn2learn.net>
36. [PyTorch/XLA](https://github.com/pytorch/xla) ⭐ 2,804 | 🐛 884 | 🌐 C++ | 📅 2026-05-27: PyTorch/XLA is a Python package that uses the XLA deep learning compiler to connect the PyTorch deep learning framework and Cloud TPUs.
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,799 | 🐛 186 | 🌐 Python | 📅 2026-09-08: Adaptive Experimentation Platform
38. [RepDistiller](https://github.com/HobbitLong/RepDistiller) ⭐ 2,440 | 🐛 34 | 🌐 Python | 📅 2023-10-16: Contrastive Representation Distillation (CRD), and benchmark of recent knowledge distillation methods
39. [rlpyt](https://github.com/astooke/rlpyt) ⭐ 2,277 | 🐛 63 | 🌐 Python | 📅 2021-01-04: Reinforcement Learning in PyTorch
40. [cvxpylayers](https://github.com/cvxgrp/cvxpylayers) ⭐ 2,130 | 🐛 28 | 🌐 Python | 📅 2026-05-19: cvxpylayers is a Python library for constructing differentiable convex optimization layers in PyTorch
41. [PyTorch-Encoding](https://github.com/zhanghang1989/PyTorch-Encoding) ⭐ 2,044 | 🐛 151 | 🌐 Python | 📅 2024-12-21: PyTorch Deep Texture Encoding Network <http://hangzh.com/PyTorch-Encoding>
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,823 | 🐛 36 | 🌐 Python | 📅 2026-09-09: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
51. [redner](https://github.com/BachiLi/redner) ⭐ 1,444 | 🐛 53 | 🌐 NASL | 📅 2022-08-19: A differentiable Monte Carlo path tracer
52. [hub](https://github.com/pytorch/hub) ⭐ 1,434 | 🐛 56 | 🌐 Python | 📅 2024-04-15: Pytorch Hub is a pre-trained model repository designed to facilitate research reproducibility.
...
54. [SLM-Lab](https://github.com/kengz/SLM-Lab) ⭐ 1,361 | 🐛 5 | 🌐 Python | 📅 2026-08-20: Modular Deep Reinforcement Learning framework in PyTorch.
55. [extension-cpp](https://github.com/pytorch/extension-cpp) ⭐ 1,202 | 🐛 53 | 🌐 Python | 📅 2026-01-13: C++ extensions in PyTorch
56. [geoopt](https://github.com/ferrine/geoopt) ⭐ 1,098 | 🐛 38 | 🌐 Python | 📅 2026-05-09: Riemannian Adaptive Optimization Methods with pytorch optim
57. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 3 | 🌐 Python | 📅 2026-09-10: Python library for Reinforcement Learning experiments.
58. [jetson-reinforcement](https://github.com/dusty-nv/jetson-reinforcement) ⭐ 932 | 🐛 30 | 🌐 C++ | 📅 2022-01-27: Deep reinforcement learning libraries for NVIDIA Jetson TX1/TX2 with PyTorch, OpenAI Gym, and Gazebo robotics simulator.
...
61. [torchgpipe](https://github.com/kakaobrain/torchgpipe) ⭐ 865 | 🐛 9 | 🌐 Python | 📅 2024-07-25: A GPipe implementation in PyTorch torchgpipe.readthedocs.io
...
63. [torchbeast](https://github.com/facebookresearch/torchbeast) ⚠️ Archived: A PyTorch Platform for Distributed RL
64. [OpenChem](https://github.com/Mariewelt/OpenChem) ⭐ 753 | 🐛 17 | 🌐 Python | 📅 2023-11-26: OpenChem: Deep Learning toolkit for Computational Chemistry and Drug Design Research mariewelt.github.io/OpenChem
65. [semi-supervised-pytorch](https://github.com/wohlert/semi-supervised-pytorch) ⭐ 709 | 🐛 6 | 🌐 Python | 📅 2020-03-02: Implementations of different VAE-based semi-supervised and generative models in PyTorch.
66. [autonomous-learning-library](https://github.com/cpnota/autonomous-learning-library) ⭐ 657 | 🐛 24 | 🌐 Python | 📅 2024-03-17: A PyTorch library for building deep reinforcement learning agents.
67. [torchbearer](https://github.com/ecs-vlc/torchbearer) ⭐ 641 | 🐛 10 | 🌐 Python | 📅 2023-12-04: torchbearer: A model training library for researchers using PyTorch.
68. [euclidesdb](https://github.com/perone/euclidesdb) ⭐ 639 | 🐛 12 | 🌐 C++ | 📅 2019-12-30: A multi-model machine learning feature embedding database <http://euclidesdb.readthedocs.io>
69. [PyTorch-LBFGS](https://github.com/hjmshi/PyTorch-LBFGS) ⭐ 630 | 🐛 9 | 🌐 Python | 📅 2023-02-21: A PyTorch implementation of L-BFGS.
...
72. [colorization-pytorch](https://github.com/richzhang/colorization-pytorch) ⭐ 601 | 🐛 15 | 🌐 Python | 📅 2020-06-04: PyTorch reimplementation of Interactive Deep Colorization richzhang.github.io/ideepcolor
...
77. [torchani](https://github.com/aiqm/torchani) ⭐ 558 | 🐛 8 | 🌐 Python | 📅 2026-09-06: Accurate Neural Network Potential on PyTorch aiqm.github.io/torchani
...
79. [pro\_gan\_pytorch](https://github.com/akanimax/pro_gan_pytorch) ⭐ 540 | 🐛 5 | 🌐 Python | 📅 2023-10-03: ProGAN package implemented as an extension of PyTorch nn.Module
...
81. [pytorch2caffe](https://github.com/longcw/pytorch2caffe) ⭐ 538 | 🐛 25 | 🌐 Python | 📅 2019-05-28: Convert PyTorch model to Caffemodel
82. [Arnold](https://github.com/glample/Arnold) ⭐ 534 | 🐛 12 | 🌐 Python | 📅 2022-01-20: Arnold - DOOM Agent
83. [pytorch-cpp-rl](https://github.com/Omegastick/pytorch-cpp-rl) ⚠️ Archived: PyTorch C++ Reinforcement Learning
84. [pixyz](https://github.com/masa-su/pixyz) ⭐ 505 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2025-09-22: a library for developing deep generative models in a more concise, intuitive and extendable way.
85. [matchbox](https://github.com/salesforce/matchbox) ⚠️ Archived: Write PyTorch code at the level of individual examples, then run it efficiently on minibatches.
86. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 474 | 🐛 7 | 🌐 Python | 📅 2026-09-09: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
87. [joint-vae](https://github.com/Schlumberger/joint-vae) ⭐ 469 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2019-04-02: Pytorch implementation of JointVAE, a framework for disentangling continuous and discrete factors of variation star2
88. [Xlearn](https://github.com/thuml/Xlearn) ⭐ 463 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2021-04-09: Transfer Learning Library
89. [Pytorch-Toolbox](https://github.com/PistonY/torch-toolbox) ⭐ 419 | 🐛 4 | 🌐 Python | 📅 2024-05-13: This is toolbox project for Pytorch. Aiming to make you write Pytorch code more easier, readable and concise.
90. [pywick](https://github.com/achaiah/pywick) ⭐ 399 | 🐛 1 | 🌐 Python | 📅 2022-02-04: High-level batteries-included neural network training library for Pytorch
91. [caffemodel2pytorch](https://github.com/vadimkantorov/caffemodel2pytorch) ⭐ 396 | 🐛 10 | 🌐 Python | 📅 2023-03-30: Convert Caffe models to PyTorch.
92. [Pytorch-contrib](https://github.com/pytorch/contrib) ⚠️ Archived: It contains reviewed implementations of ideas from recent machine learning papers.
93. [argus-tensor-stream](https://github.com/Fonbet/argus-tensor-stream) ⭐ 388 | 🐛 7 | 🌐 C++ | 📅 2023-04-27: A library for real-time video stream decoding to CUDA memory tensorstream.argus-ai.com
94. [torch2coreml](https://github.com/prisma-ai/torch2coreml) ⚠️ Archived: Torch7 -> CoreML
95. [lagom](https://github.com/zuoxingdong/lagom) ⭐ 378 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2022-11-19: lagom: A light PyTorch infrastructure to quickly prototype reinforcement learning algorithms.
96. [nonechucks](https://github.com/msamogh/nonechucks) ⭐ 377 | 🐛 20 | 🌐 Python | 📅 2022-09-22: Skip bad items in your PyTorch DataLoader, use Transforms as Filters, and more!
97. [opencv\_transforms](https://github.com/jbohnslav/opencv_transforms) ⭐ 375 | 🐛 7 | 🌐 Python | 📅 2025-08-08: OpenCV implementation of Torchvision's image augmentations
98. [magnet](https://github.com/MagNet-DL/magnet) ⭐ 359 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2019-01-10: Deep Learning Projects that Build Themselves <http://magnet-dl.readthedocs.io/>
99. [salad](https://github.com/domainadaptation/salad) ⭐ 341 | 🐛 32 | 🌐 HTML | 📅 2021-05-15: Semi-Supervised Learning and Domain Adaptation.
100. [sparktorch](https://github.com/dmmiller612/sparktorch) ⭐ 339 | 🐛 16 | 🌐 Python | 📅 2023-05-11: Train and run Pytorch models on Apache Spark.
101. [torchdrift](https://github.com/torchdrift/torchdrift/) ⭐ 328 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2022-08-26: drift detection library
102. [pytorch\_fft](https://github.com/locuslab/pytorch_fft) ⭐ 317 | 🐛 14 | 🌐 Python | 📅 2018-10-28: PyTorch wrapper for FFTs
103. [Renate](https://github.com/awslabs/renate) ⚠️ Archived: A library for real-world continual learning.
104. [volksdep](https://github.com/Media-Smart/volksdep) ⭐ 285 | 🐛 6 | 🌐 Python | 📅 2021-02-05: volksdep is an open-source toolbox for deploying and accelerating PyTorch, Onnx and Tensorflow models with TensorRT.
105. [vel](https://github.com/MillionIntegrals/vel) ⭐ 280 | 🐛 16 | 🌐 Python | 📅 2022-12-08: Velocity in deep-learning research.
106. [pyinn](https://github.com/szagoruyko/pyinn) ⭐ 273 | 🐛 16 | 🌐 Python | 📅 2018-02-15: CuPy fused PyTorch neural networks ops
107. [flambe](https://github.com/asappresearch/flambe) ⭐ 271 | 🐛 22 | 🌐 Python | 📅 2024-09-03: An ML framework to accelerate research and its path to production. flambe.ai
108. [mctorch](https://github.com/mctorch/mctorch) ⭐ 256 | 🐛 10 | 🌐 Python | 📅 2021-08-10: A manifold optimization library for deep learning.
109. [inferno](https://github.com/nasimrahaman/inferno) ⚠️ Archived: A utility library around PyTorch
110. [torch-two-sample](https://github.com/josipd/torch-two-sample) ⭐ 245 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2025-11-12: A PyTorch library for two-sample tests
111. [dni-pytorch](https://github.com/koz4k/dni-pytorch) ⭐ 237 | 🐛 4 | 🌐 Python | 📅 2019-01-12: Decoupled Neural Interfaces using Synthetic Gradients for PyTorch.
112. [PySNN](https://github.com/BasBuller/PySNN) ⭐ 234 | 🐛 4 | 🌐 Python | 📅 2024-07-31: Efficient Spiking Neural Network framework, built on top of PyTorch for GPU acceleration.
113. [pytorch-tools](https://github.com/nearai/pytorch-tools) ⭐ 225 | 🐛 7 | 🌐 Python | 📅 2022-08-10: Tools for PyTorch
114. [delira](https://github.com/justusschock/delira) ⚠️ Archived: Lightweight framework for fast prototyping and training deep neural networks in medical imaging delira.rtfd.io
115. [pydlt](https://github.com/dmarnerides/pydlt) ⭐ 206 | 🐛 0 | 🌐 Python | 📅 2018-07-27: PyTorch based Deep Learning Toolbox
116. [fenchel-young-losses](https://github.com/mblondel/fenchel-young-losses) ⭐ 196 | 🐛 0 | 🌐 Python | 📅 2023-09-19: Probabilistic classification in PyTorch/TensorFlow/scikit-learn with Fenchel-Young losses
117. [beauty-net](https://github.com/cms-flash/beauty-net) ⭐ 192 | 🐛 0 | 🌐 Python | 📅 2023-11-07: A simple, flexible, and extensible template for PyTorch. It's beautiful.
118. [hessian](https://github.com/mariogeiger/hessian) ⭐ 187 | 🐛 0 | 🌐 Python | 📅 2020-10-27: hessian in pytorch.
119. [pywarm](https://github.com/blue-season/pywarm) ⭐ 183 | 🐛 0 | 🌐 Python | 📅 2019-09-23: A cleaner way to build neural networks for PyTorch. blue-season.github.io/pywarm
...
123. [Pytorch Geometric Signed Directed](https://github.com/SherylHYX/pytorch_geometric_signed_directed) ⭐ 148 | 🐛 0 | 🌐 Python | 📅 2026-09-03: A signed and directed extension library for PyTorch Geometric.
...
127. [Torchelie](https://github.com/Vermeille/Torchelie/) ⭐ 111 | 🐛 24 | 🌐 Python | 📅 2026-07-20: Torchélie is a set of utility functions, layers, losses, models, trainers and other things for PyTorch. torchelie.readthedocs.org
128. [macarico](https://github.com/hal3/macarico) ⭐ 110 | 🐛 19 | 🌐 Python | 📅 2020-02-18: learning to search in pytorch
129. [pytorch-fitmodule](https://github.com/henryre/pytorch-fitmodule) ⚠️ Archived: Super simple fit method for PyTorch modules
130. [pytorch-mcn](https://github.com/albanie/pytorch-mcn) ⭐ 95 | 🐛 3 | 🌐 Python | 📅 2019-01-06: Convert models from MatConvNet to PyTorch
131. [cogitare](https://github.com/cogitare-ai/cogitare) ⚠️ Archived: Cogitare - A Modern, Fast, and Modular Deep Learning and Machine Learning framework in Python.
132. [candlegp](https://github.com/t-vi/candlegp) ⭐ 76 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2020-02-26: Gaussian Processes in Pytorch.
133. [torchcraft-py](https://github.com/deepcraft/torchcraft-py) ⚠️ Archived: Python wrapper for TorchCraft, a bridge between Torch and StarCraft for AI research.
134. [osqpth](https://github.com/oxfordcontrol/osqpth) ⭐ 67 | 🐛 8 | 🌐 Python | 📅 2022-12-26: The differentiable OSQP solver layer for PyTorch.
135. [aorun](https://github.com/ramon-oliveira/aorun) ⭐ 62 | 🐛 0 | 🌐 Python | 📅 2017-09-06: Aorun intend to be a Keras with PyTorch as backend.
136. [diffdist](https://github.com/ag14774/diffdist) ⭐ 62 | 🐛 1 | 🌐 Python | 📅 2020-06-18: diffdist is a python library for pytorch. It extends the default functionality of torch.autograd and adds support for differentiable communication between processes.
137. [Tor10](https://github.com/kaihsin/Tor10) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2019-06-21: A Generic Tensor-Network library that is designed for quantum simulation, base on the pytorch.
...
139. [generative\_zoo](https://github.com/DL-IT/generative_zoo) ⭐ 54 | 🐛 2 | 🌐 Python | 📅 2018-12-19: generative\_zoo is a repository that provides working implementations of some generative models in PyTorch.
140. [dpwa](https://github.com/loudinthecloud/dpwa) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2017-10-31: Distributed Learning by Pair-Wise Averaging.
141. [pytorch extras](https://github.com/mrdrozdov/pytorch-extras) ⭐ 49 | 🐛 0 | 🌐 Python | 📅 2017-03-13: Some extra features for pytorch.
142. [pytorch-ctc](https://github.com/ryanleary/pytorch-ctc) ⭐ 42 | 🐛 0 | 🌐 C++ | 📅 2018-01-31: PyTorch-CTC is an implementation of CTC (Connectionist Temporal Classification) beam search decoding for PyTorch. C++ code borrowed liberally from TensorFlow with some improvements to increase flexibility.
143. [netharn](https://github.com/Erotemic/netharn) ⭐ 39 | 🐛 2 | 🌐 Python | 📅 2020-10-23: Parameterized fit and prediction harnesses for pytorch.
144. [sru](https://github.com/taolei87/sru) ⭐ 38 | 🐛 1 | 📅 2021-09-28: Training RNNs as Fast as CNNs (arxiv.org/abs/1709.02755)
145. [PyTorch-docset](https://github.com/iamaziz/PyTorch-docset) ⭐ 34 | 🐛 2 | 🌐 Python | 📅 2017-08-15: PyTorch docset! use with Dash, Zeal, Velocity, or LovelyDocs.
146. [Torchlite](https://github.com/EKami/Torchlite) ⭐ 31 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2022-09-29: A high level library on top of(not only) Pytorch
147. [neural-assembly-compiler](https://github.com/aditya-khant/neural-assembly-compiler) ⭐ 27 | 🐛 0 | 🌐 Haskell | 📅 2018-03-27: A neural assembly compiler for pyTorch based on adaptive-neural-compilation.
148. [pytorch-cns](https://github.com/awentzonline/pytorch-cns) ⭐ 26 | 🐛 3 | 🌐 Python | 📅 2017-11-01: Compressed Network Search with PyTorch
149. [torchplus](https://github.com/knighton/torchplus) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2019-04-11: Implements the + operator on PyTorch modules, returning sequences.
150. [ANEE](https://github.com/abkmystery/ANEE) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2025-11-30 – Adaptive Neural Execution Engine for PyTorch transformers. Provides per-token dynamic layer skipping, profiler-based gating, and KV-cache-safe sparse inference.
151. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 0 | 🐛 0 | 📅 2026-09-09: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,407 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,134 | 🐛 59 | 🌐 Python | 📅 2026-09-09: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,488 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,036 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,322 | 🐛 258 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
9. [pytorch-sentiment-analysis](https://github.com/bentrevett/pytorch-sentiment-analysis) ⭐ 4,611 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-03-27: Tutorials on getting started with PyTorch and TorchText for sentiment analysis.
10. **[Practical Pytorch](https://github.com/spro/practical-pytorch) ⚠️ Archived**: Tutorials explaining different RNN models
11. [d2l-pytorch](https://github.com/dsgiitr/d2l-pytorch) ⭐ 4,362 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-07-25: This is an attempt to modify Dive into Deep Learning, Berkeley STAT 157 (Spring 2019) textbook's code into PyTorch.
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,178 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
15. [code-of-learn-deep-learning-with-pytorch](https://github.com/SherlockLiao/code-of-learn-deep-learning-with-pytorch) ⭐ 2,873 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2024-03-04: This is code of book "Learn Deep Learning with PyTorch" item.jd.com/17915495606.html
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,488 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
18. [grokking-pytorch](https://github.com/Kaixhin/grokking-pytorch) ⭐ 1,199 | 🐛 0 | 📅 2021-09-13: The Hitchiker's Guide to PyTorch
...
28. [tensorly-notebooks](https://github.com/JeanKossaifi/tensorly-notebooks) ⭐ 450 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2023-02-13: Tensor methods in Python with TensorLy tensorly.github.io/dev
29. [NER-BERT-pytorch](https://github.com/lemonhu/NER-BERT-pytorch) ⭐ 445 | 🐛 19 | 🌐 Python | 📅 2023-03-30: PyTorch solution of named entity recognition task Using Google AI's pre-trained BERT model.
...
31. [thinking-in-tensors-writing-in-pytorch](https://github.com/stared/thinking-in-tensors-writing-in-pytorch) ⭐ 397 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2025-01-10: Thinking in tensors, writing in PyTorch (a hands-on deep learning intro).
32. [pytorch\_notebooks - hardmaru](https://github.com/hardmaru/pytorch_notebooks) ⭐ 392 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2018-04-05: Random tutorials created in NumPy and PyTorch.
...
37. [pytorch\_exercises](https://github.com/Kyubyong/pytorch_exercises) ⭐ 316 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2017-09-28: pytorch-exercises
...
39. [pytorch-REINFORCE](https://github.com/JamesChuanggg/pytorch-REINFORCE) ⭐ 265 | 🐛 5 | 🌐 Python | 📅 2017-04-16: PyTorch implementation of REINFORCE, This repo supports both continuous and discrete environments in OpenAI gym.
40. [pytorch-sync-batchnorm-example](https://github.com/dougsouza/pytorch-sync-batchnorm-example) ⭐ 247 | 🐛 0 | 📅 2019-05-13: How to use Cross Replica / Synchronized Batchnorm in Pytorch.
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 165,066 | 🐛 2,415 | 🌐 Python | 📅 2026-09-10: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,239 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
3. [PyTorch-GAN](https://github.com/eriklindernoren/PyTorch-GAN) ⭐ 17,449 | 🐛 142 | 🌐 Python | 📅 2024-06-18: PyTorch implementations of Generative Adversarial Networks.
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,967 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
5. [FastPhotoStyle](https://github.com/NVIDIA/FastPhotoStyle) ⭐ 11,172 | 🐛 57 | 🌐 Python | 📅 2023-06-07: A Closed-form Solution to Photorealistic Image Stylization
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,601 | 🐛 4 | 🌐 Python | 📅 2026-09-10: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,789 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
8. [vid2vid](https://github.com/NVIDIA/vid2vid) ⭐ 8,692 | 🐛 110 | 🌐 Python | 📅 2022-05-17: Pytorch implementation of our method for high-resolution (e.g. 2048x1024) photorealistic video-to-video translation.
9. [deep-image-prior](https://github.com/DmitryUlyanov/deep-image-prior) ⭐ 8,089 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2023-04-27: Image restoration with neural networks but without learning.
...
11. [faster-rcnn.pytorch](https://github.com/jwyang/faster-rcnn.pytorch) ⭐ 7,855 | 🐛 422 | 🌐 Python | 📅 2022-05-20: This project is a faster faster R-CNN implementation, aimed to accelerating the training of faster R-CNN object detection models.
12. [face-alignment](https://github.com/1adrianb/face-alignment) ⭐ 7,537 | 🐛 91 | 🌐 Python | 📅 2026-04-06: Pytorch implementation of the paper "How far are we from solving the 2D & 3D Face Alignment problem? (and a dataset of 230,000 3D facial landmarks)", ICCV 2017
13. [pix2pixHD](https://github.com/NVIDIA/pix2pixHD) ⭐ 6,923 | 🐛 247 | 🌐 Python | 📅 2024-11-04: Synthesizing and manipulating 2048x1024 images with conditional GANs tcwang0509.github.io/pix2pixHD
...
17. [StarGAN](https://github.com/yunjey/StarGAN) ⭐ 5,296 | 🐛 67 | 🌐 Python | 📅 2021-01-23: StarGAN: Unified Generative Adversarial Networks for Multi-Domain Image-to-Image Tranlsation.
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,557 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
22. [Person-reID\_pytorch](https://github.com/layumi/Person_reID_baseline_pytorch) ⭐ 4,445 | 🐛 174 | 🌐 Python | 📅 2026-08-30: PyTorch for Person re-ID.
23. [3D-ResNets-PyTorch](https://github.com/kenshohara/3D-ResNets-PyTorch) ⭐ 4,036 | 🐛 154 | 🌐 Python | 📅 2021-01-20: 3D ResNets for Action Recognition.
...
26. [Transformer-XL](https://github.com/kimiyoung/transformer-xl) ⭐ 3,714 | 🐛 98 | 🌐 Python | 📅 2022-09-21: Transformer-XL: Attentive Language Models Beyond a Fixed-Length Contexthttps\://github.com/kimiyoung/transformer-xl
...
28. [FlowNet 2.0](https://github.com/NVIDIA/flownet2-pytorch) ⭐ 3,291 | 🐛 168 | 🌐 Python | 📅 2026-03-30: FlowNet 2.0: Evolution of Optical Flow Estimation with Deep Networks
29. [WassersteinGAN](https://github.com/martinarjovsky/WassersteinGAN) ⭐ 3,244 | 🐛 28 | 🌐 Python | 📅 2018-12-26: wassersteinGAN in pytorch.
30. [loss-landscape](https://github.com/tomgoldstein/loss-landscape) ⭐ 3,202 | 🐛 30 | 🌐 Python | 📅 2022-04-05: loss-landscape Code for visualizing the loss landscape of neural nets.
...
34. **[pytorch-playground](https://github.com/aaron-xichen/pytorch-playground) ⭐ 2,719 | 🐛 11 | 🌐 Python | 📅 2022-11-22: Base pretrained models and datasets in pytorch (MNIST, SVHN, CIFAR10, CIFAR100, STL10, AlexNet, VGG16, VGG19, ResNet, Inception, SqueezeNet)**.
35. [ENAS-pytorch](https://github.com/carpedm20/ENAS-pytorch) ⭐ 2,718 | 🐛 40 | 🌐 Python | 📅 2023-07-06: PyTorch implementation of "Efficient Neural Architecture Search via Parameters Sharing".
...
37. [EDSR-PyTorch](https://github.com/thstkdgus35/EDSR-PyTorch) ⭐ 2,628 | 🐛 142 | 🌐 Python | 📅 2023-01-03: PyTorch version of the paper 'Enhanced Deep Residual Networks for Single Image Super-Resolution' (CVPRW 2017)
38. [pytorch-generative-model-collections](https://github.com/znxlwm/pytorch-generative-model-collections) ⭐ 2,627 | 🐛 27 | 🌐 Python | 📅 2020-04-12:  Collection of generative models in Pytorch version.
39. [pointnet.pytorch](https://github.com/fxia22/pointnet.pytorch) ⭐ 2,355 | 🐛 59 | 🌐 Python | 📅 2023-03-23: pytorch implementation for "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" <https://arxiv.org/abs/1612.00593>
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,033 | 🐛 128 | 🌐 Python | 📅 2026-09-06: A Python library for learning and evaluating knowledge graph embeddings.
...
45. [NVIDIA/semantic-segmentation](https://github.com/NVIDIA/semantic-segmentation) ⭐ 1,829 | 🐛 89 | 🌐 Python | 📅 2021-07-26: A PyTorch Implementation of [Improving Semantic Segmentation via Video Propagation and Label Relaxation](https://arxiv.org/abs/1812.01593), In CVPR2019.
...
50. [Rainbow](https://github.com/Kaixhin/Rainbow) ⭐ 1,673 | 🐛 9 | 🌐 Python | 📅 2022-01-13: Rainbow: Combining Improvements in Deep Reinforcement Learning
...
54. [efficient\_densenet\_pytorch](https://github.com/gpleiss/efficient_densenet_pytorch) ⭐ 1,534 | 🐛 12 | 🌐 Python | 📅 2023-06-01: A memory-efficient implementation of DenseNets
55. [pytorch-openai-transformer-lm](https://github.com/huggingface/pytorch-openai-transformer-lm) ⭐ 1,524 | 🐛 24 | 🌐 Python | 📅 2021-08-09: This is a PyTorch implementation of the TensorFlow code provided with OpenAI's paper "Improving Language Understanding by Generative Pre-Training" by Alec Radford, Karthik Narasimhan, Tim Salimans and Ilya Sutskever.
56. [neuraltalk2-pytorch](https://github.com/ruotianluo/neuraltalk2.pytorch) ⭐ 1,476 | 🐛 99 | 🌐 Python | 📅 2023-10-05: image captioning model in pytorch(finetunable cnn in branch with\_finetune)
...
61. [NVlabs/DG-Net](https://github.com/NVlabs/DG-Net) ⭐ 1,298 | 🐛 45 | 🌐 Python | 📅 2023-07-09: A PyTorch implementation of "Joint Discriminative and Generative Learning for Person Re-identification" (CVPR19 Oral).
...
65. [voicefilter](https://github.com/mindslab-ai/voicefilter) ⭐ 1,219 | 🐛 13 | 🌐 Python | 📅 2024-07-25: Unofficial PyTorch implementation of Google AI's VoiceFilter system <http://swpark.me/voicefilter>.
...
74. [PyTorch-Style-Transfer](https://github.com/zhanghang1989/PyTorch-Style-Transfer) ⭐ 1,008 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2022-05-12: PyTorch Implementation of Multi-style Generative Network for Real-time Transfer
...
76. [pytorch-retinanet](https://github.com/kuangliu/pytorch-retinanet) ⭐ 996 | 🐛 51 | 🌐 Python | 📅 2019-03-17: RetinaNet in PyTorch
...
79. [GAN\_stability](https://github.com/LMescheder/GAN_stability) ⭐ 920 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2019-08-27: Code for paper "Which Training Methods for GANs do actually Converge? (ICML 2018)"
...
81. [flownet](https://github.com/ClementPinard/FlowNetPytorch) ⭐ 901 | 🐛 7 | 🌐 Python | 📅 2026-04-15: Pytorch implementation of FlowNet by Dosovitskiy et al.
...
83. [pytorch-pruning](https://github.com/jacobgil/pytorch-pruning) ⭐ 884 | 🐛 31 | 🌐 Python | 📅 2019-07-12: PyTorch Implementation of \[1611.06440] Pruning Convolutional Neural Networks for Resource Efficient Inference
84. [neural-style-pt](https://github.com/ProGamerGov/neural-style-pt) ⭐ 855 | 🐛 25 | 🌐 Python | 📅 2022-10-15: A PyTorch implementation of Justin Johnson's Neural-style.
85. [FaceBoxes.PyTorch](https://github.com/zisianw/FaceBoxes.PyTorch) ⭐ 851 | 🐛 18 | 🌐 Python | 📅 2024-12-11: A PyTorch Implementation of FaceBoxes.
86. [stackGAN-v2](https://github.com/hanzhanggit/StackGAN-v2) ⭐ 846 | 🐛 35 | 🌐 Python | 📅 2020-01-13: Pytorch implementation for reproducing StackGAN\_v2 results in the paper StackGAN++: Realistic Image Synthesis with Stacked Generative Adversarial Networks by Han Zhang\*, Tao Xu\*, Hongsheng Li, Shaoting Zhang, Xiaogang Wang, Xiaolei Huang, Dimitris Metaxas.
87. [DEXTR-PyTorch](https://github.com/scaelles/DEXTR-PyTorch) ⭐ 845 | 🐛 3 | 🌐 Python | 📅 2020-09-04: Deep Extreme Cut <http://www.vision.ee.ethz.ch/~cvlsegmentation/dextr>
88. [LM-LSTM-CRF](https://github.com/LiyuanLucasLiu/LM-LSTM-CRF) ⭐ 844 | 🐛 18 | 🌐 Python | 📅 2022-06-22: Empower Sequence Labeling with Task-Aware Language Model <http://arxiv.org/abs/1709.04109>
89. [densenet](https://github.com/bamos/densenet.pytorch) ⭐ 840 | 🐛 7 | 🌐 Python | 📅 2018-08-16: This is a PyTorch implementation of the DenseNet-BC architecture as described in the paper Densely Connected Convolutional Networks by G. Huang, Z. Liu, K. Weinberger, and L. van der Maaten. This implementation gets a CIFAR-10+ error rate of 4.77 with a 100-layer DenseNet-BC with a growth rate of 12. Their official implementation and links to many other third-party implementations are available in the liuzhuang13/DenseNet repo on GitHub.
...
91. [SimGNN](https://github.com/benedekrozemberczki/SimGNN) ⭐ 813 | 🐛 9 | 🌐 Python | 📅 2023-01-12: SimGNN: A Neural Network Approach to Fast Graph Similarity Computation.
...
94. [qp solver](https://github.com/locuslab/qpth) ⭐ 801 | 🐛 17 | 🌐 Python | 📅 2024-09-03: A fast and differentiable QP solver for PyTorch. Crafted by Brandon Amos and J. Zico Kolter.
...
100. [vnet.pytorch](https://github.com/mattmacy/vnet.pytorch) ⭐ 757 | 🐛 26 | 🌐 Python | 📅 2018-07-06: A Pytorch implementation for V-Net: Fully Convolutional Neural Networks for Volumetric Medical Image Segmentation.
101. [seq2seq](https://github.com/MaximumEntropy/Seq2Seq-PyTorch) ⭐ 739 | 🐛 6 | 🌐 Python | 📅 2022-03-27: This repository contains implementations of Sequence to Sequence (Seq2Seq) models in PyTorch
...
104. [sphereface\_pytorch](https://github.com/clcarwin/sphereface_pytorch) ⭐ 713 | 🐛 35 | 🌐 Python | 📅 2022-02-01: A PyTorch Implementation of SphereFace.
105. [ConvE](https://github.com/TimDettmers/ConvE) ⭐ 691 | 🐛 24 | 🌐 Python | 📅 2024-03-29: Convolutional 2D Knowledge Graph Embeddings
...
115. [optnet](https://github.com/locuslab/optnet) ⭐ 593 | 🐛 3 | 🌐 Python | 📅 2020-03-26: This repository is by Brandon Amos and J. Zico Kolter and contains the PyTorch source code to reproduce the experiments in our paper OptNet: Differentiable Optimization as a Layer in Neural Networks.
116. [pspnet-pytorch](https://github.com/Lextal/pspnet-pytorch) ⭐ 590 | 🐛 17 | 🌐 Python | 📅 2017-10-06: PyTorch implementation of PSPNet segmentation network
117. [pytorch-flows](https://github.com/ikostrikov/pytorch-flows) ⭐ 589 | 🐛 5 | 🌐 Python | 📅 2021-05-13: PyTorch implementations of algorithms for density estimation
...
120. [pytorch-maml](https://github.com/katerakelly/pytorch-maml) ⭐ 566 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2018-10-04: PyTorch implementation of MAML: arxiv.org/abs/1703.03400
121. [rl\_a3c\_pytorch](https://github.com/dgriff777/rl_a3c_pytorch) ⭐ 564 | 🐛 13 | 🌐 Python | 📅 2023-04-18: Reinforcement learning with implementation of A3C LSTM for Atari 2600.
...
124. [T2F](https://github.com/akanimax/T2F) ⭐ 545 | 🐛 18 | 🌐 Python | 📅 2022-05-14: Text-to-Face generation using Deep Learning. This project combines two of the recent architectures StackGAN and ProGAN for synthesizing faces from textual descriptions.
125. [glow-pytorch](https://github.com/rosinality/glow-pytorch) ⭐ 545 | 🐛 33 | 🌐 Python | 📅 2021-11-20: PyTorch implementation of Glow, Generative Flow with Invertible 1x1 Convolutions (arxiv.org/abs/1807.03039)
126. [honk](https://github.com/castorini/honk) ⭐ 527 | 🐛 7 | 🌐 Python | 📅 2023-05-22: PyTorch reimplementation of Google's TensorFlow CNNs for keyword spotting.
127. [pytorch-coviar](https://github.com/chaoyuaw/pytorch-coviar) ⭐ 525 | 🐛 56 | 🌐 Python | 📅 2018-07-06: Compressed Video Action Recognition
...
131. [/pytorch-SRResNet](https://github.com/twtygqyy/pytorch-SRResNet) ⭐ 511 | 🐛 25 | 🌐 Python | 📅 2018-03-26: pytorch implementation for Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network arXiv:1609.04802v2
...
139. [ggnn.pytorch](https://github.com/JamesChuanggg/ggnn.pytorch) ⭐ 468 | 🐛 2 | 🌐 Python | 📅 2019-07-31: A PyTorch Implementation of Gated Graph Sequence Neural Networks (GGNN).
140. [pytorch-trpo(Hessian-vector product version)](https://github.com/ikostrikov/pytorch-trpo) ⭐ 449 | 🐛 7 | 🌐 Python | 📅 2018-09-13: This is a PyTorch implementation of "Trust Region Policy Optimization (TRPO)" with exact Hessian-vector product instead of finite differences approximation.
...
143. [mnist-svhn-transfer](https://github.com/yunjey/mnist-svhn-transfer) ⭐ 439 | 🐛 8 | 🌐 Python | 📅 2017-05-27: PyTorch Implementation of CycleGAN and SGAN for Domain Transfer (Minimal).
...
146. [pytorch-dqn](https://github.com/transedward/pytorch-dqn) ⭐ 430 | 🐛 10 | 🌐 Python | 📅 2017-11-01: Deep Q-Learning Network in pytorch.
147. [fast-neural-style](https://github.com/darkstar112358/fast-neural-style) ⭐ 429 | 🐛 5 | 🌐 Python | 📅 2024-07-25: pytorch implementation of fast-neural-style, The model uses the method described in [Perceptual Losses for Real-Time Style Transfer and Super-Resolution](https://arxiv.org/abs/1603.08155) along with Instance Normalization.
148. [densebody\_pytorch](https://github.com/Lotayou/densebody_pytorch) ⭐ 412 | 🐛 13 | 🌐 Python | 📅 2019-08-26: PyTorch implementation of CloudWalk's recent paper DenseBody.
...
157. [pytorch-i-revnet](https://github.com/jhjacobsen/pytorch-i-revnet) ⭐ 398 | 🐛 3 | 🌐 Python | 📅 2021-02-16: Pytorch implementation of i-RevNets.
158. [Seg-Uncertainty](https://github.com/layumi/Seg-Uncertainty) ⭐ 397 | 🐛 9 | 🌐 Python | 📅 2025-10-24: Unsupervised Scene Adaptation with Memory Regularization in vivo, In IJCAI 2020.
...
162. [TuckER](https://github.com/ibalazevic/TuckER) ⭐ 370 | 🐛 2 | 🌐 Python | 📅 2023-11-16: TuckER: Tensor Factorization for Knowledge Graph Completion.
...
165. [Learning to Communicate with Deep Multi-Agent Reinforcement Learning](https://github.com/minqi/learning-to-communicate-pytorch) ⭐ 358 | 🐛 2 | 🌐 Python | 📅 2019-04-01: pytorch implementation of  Learning to Communicate with Deep Multi-Agent Reinforcement Learning paper.
...
168. [dnc](https://github.com/ixaxaar/pytorch-dnc) ⭐ 350 | 🐛 8 | 🌐 Python | 📅 2026-09-01: Differentiable Neural Computers, for Pytorch
...
171. [QANet-pytorch](https://github.com/hengruo/QANet-pytorch) ⭐ 342 | 🐛 6 | 🌐 Python | 📅 2026-07-28: an implementation of QANet with PyTorch (EM/F1 = 70.5/77.2 after 20 epoches for about 20 hours on one 1080Ti card.)
...
178. [PyTorchWavelets](https://github.com/tomrunia/PyTorchWavelets) ⭐ 318 | 🐛 5 | 🌐 Python | 📅 2022-02-03: PyTorch implementation of the wavelet analysis found in Torrence and Compo (1998)
179. [Pytorch-NCE](https://github.com/Stonesjtu/Pytorch-NCE) ⭐ 318 | 🐛 3 | 🌐 Python | 📅 2019-11-06: The Noise Contrastive Estimation for softmax output written in Pytorch
180. [pytorch-value-iteration-networks](https://github.com/kentsommer/pytorch-value-iteration-networks) ⭐ 317 | 🐛 1 | 🌐 Python | 📅 2020-10-02: Pytorch implementation of Value Iteration Networks (NIPS 2016 best paper)
...
184. [Continuous Deep Q-Learning with Model-based Acceleration ](https://github.com/ikostrikov/pytorch-naf) ⭐ 312 | 🐛 7 | 🌐 Python | 📅 2021-02-16: Reimplementation of Continuous Deep Q-Learning with Model-based Acceleration.
...
188. [pytorch-sgns](https://github.com/theeluwin/pytorch-sgns) ⭐ 301 | 🐛 5 | 🌐 Python | 📅 2021-03-21: Skipgram Negative Sampling in PyTorch.
...
199. [GAM](https://github.com/benedekrozemberczki/GAM) ⭐ 276 | 🐛 2 | 🌐 Python | 📅 2022-11-06: This is a Pytorch implementation of Graph Classification using Structural Attention. KDD 2018.
...
202. [FewShotLearning](https://github.com/gitabcworld/FewShotLearning) ⭐ 266 | 🐛 9 | 🌐 Python | 📅 2017-09-22: Pytorch implementation of the paper "Optimization as a Model for Few-Shot Learning"
...
230. [odin-pytorch](https://github.com/ShiyuLiang/odin-pytorch) ⭐ 201 | 🐛 4 | 🌐 Python | 📅 2017-06-28: Principled Detection of Out-of-Distribution Examples in Neural Networks.
...
240. [Deep-Image-Analogy-PyTorch](https://github.com/Ben-Louis/Deep-Image-Analogy-PyTorch) ⭐ 186 | 🐛 4 | 🌐 Python | 📅 2021-12-11: A python implementation of Deep-Image-Analogy based on pytorch.
241. [distance-encoding](https://github.com/snap-stanford/distance-encoding) ⭐ 186 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2021-03-20: Distance-Encoding - Design Provably More PowerfulGNNs for Structural Representation Learning.
...
247. [pytorch-sift](https://github.com/ducha-aiki/pytorch-sift) ⭐ 173 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2019-08-22: PyTorch implementation of SIFT descriptor.
248. [fmpytorch](https://github.com/jmhessel/fmpytorch) ⭐ 172 | 🐛 0 | 🌐 Python | 📅 2018-03-12: A PyTorch implementation of a Factorization Machine module in cython.
...
253. [FCN-pytorch-easiest](https://github.com/yunlongdong/FCN-pytorch-easiest) ⭐ 159 | 🐛 6 | 🌐 Python | 📅 2018-12-23: trying to be the most easiest and just get-to-use pytorch implementation of FCN (Fully Convolotional Networks)
254. [pytorch-pose-estimation](https://github.com/DavexPro/pytorch-pose-estimation) ⭐ 158 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2017-12-26: PyTorch Implementation of Realtime Multi-Person Pose Estimation project.
...
261. [interaction\_network\_pytorch](https://github.com/higgsfield/interaction_network_pytorch) ⭐ 138 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2017-12-27: Pytorch Implementation of Interaction Networks for Learning about Objects, Relations and Physics.
262. [pytorch-prunes](https://github.com/BayesWatch/pytorch-prunes) ⭐ 138 | 🐛 1 | 🌐 Python | 📅 2019-08-28: Pruning neural networks: is it time to nip it in the bud?
...
286. [deep-dream-in-pytorch](https://github.com/duc0/deep-dream-in-pytorch) ⭐ 101 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2019-12-21: Pytorch implementation of the DeepDream computer vision algorithm.
...
291. [molencoder](https://github.com/cxhernandez/molencoder) ⭐ 94 | 🐛 4 | 🌐 Python | 📅 2026-01-16: Molecular AutoEncoder in PyTorch
...
297. [ppo\_pytorch\_cpp](https://github.com/mhubii/ppo_pytorch_cpp) ⭐ 91 | 🐛 1 | 🌐 C++ | 📅 2022-09-01: This is an implementation of the proximal policy optimization algorithm for the C++ API of Pytorch.
...
315. [Pathfinder Discovery Networks](https://github.com/benedekrozemberczki/PDN) ⭐ 58 | 🐛 0 | 🌐 Python | 📅 2025-12-28: Pathfinder Discovery Networks for Neural Message Passing.
316. [pnn.pytorch](https://github.com/michaelklachko/pnn.pytorch) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2018-10-08: PyTorch implementation of CVPR'18 - Perturbative Neural Networks <http://xujuefei.com/pnn.html>.
317. [binary-stochastic-neurons](https://github.com/Wizaron/binary-stochastic-neurons) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2018-01-06: Binary Stochastic Neurons in PyTorch.
...
338. [SSSNET](https://github.com/SherylHYX/SSSNET_Signed_Clustering) ⭐ 24 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-10-13: Official implementation of the SDM2022 paper "SSSNET: Semi-Supervised Signed Network Clustering".
339. [lgamma](https://github.com/rachtsingh/lgamma) ⭐ 23 | 🐛 2 | 🌐 C | 📅 2017-07-08: Implementations of polygamma, lgamma, and beta functions for PyTorch
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,640 | 🐛 3 | 📅 2026-07-22**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,463 | 🐛 9 | 🌐 Python | 📅 2026-09-07
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,483 | 🐛 248 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
5. [pytorch-template](https://github.com/victoresque/pytorch-template) ⭐ 5,119 | 🐛 23 | 🌐 Python | 📅 2024-06-04: PyTorch template project
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,905 | 🐛 164 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
7. [AlphaZero\_Gomoku](https://github.com/junxiaosong/AlphaZero_Gomoku) ⭐ 3,629 | 🐛 80 | 🌐 Python | 📅 2024-04-24: An implementation of the AlphaZero algorithm for Gomoku (also called Gobang or Five in a Row)
8. [ML Workspace](https://github.com/ml-tooling/ml-workspace) ⭐ 3,545 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-07-26: All-in-one web IDE for machine learning and data science. Combines Jupyter, VS Code, PyTorch, and many other tools/libraries into one Docker image.
9. [DoodleMaster](https://github.com/karanchahal/DoodleMaster) ⭐ 2,408 | 🐛 2 | 🌐 JavaScript | 📅 2019-10-31: "Don't code your UI, Draw it !"
10. [PyTorch Style Guide](https://github.com/IgorSusmelj/pytorch-styleguide) ⭐ 2,019 | 🐛 9 | 🌐 Python | 📅 2021-12-28 Style guide for PyTorch code. Consistent and good code style helps collaboration and prevents errors!
11. [hasktorch](https://github.com/hasktorch/hasktorch) ⭐ 1,215 | 🐛 89 | 🌐 Haskell | 📅 2026-08-19: Tensors and neural networks in Haskell
...
13. [pytorch-tvmisc](https://github.com/t-vi/pytorch-tvmisc) ⭐ 475 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2022-03-20: Totally Versatile Miscellanea for Pytorch
14. [nimtorch](https://github.com/fragcolor-xyz/nimtorch) ⭐ 472 | 🐛 10 | 🌐 Nim | 📅 2019-06-08: PyTorch - Python + Nim
15. [ocaml-torch](https://github.com/LaurentMazare/ocaml-torch) ⭐ 443 | 🐛 11 | 🌐 OCaml | 📅 2024-10-17: OCaml bindings for PyTorch.
16. [pytorch-scripts](https://github.com/peterjc123/pytorch-scripts) ⚠️ Archived: A few Windows specific scripts for PyTorch.
17. [Amazon\_Forest\_Computer\_Vision](https://github.com/mratsim/Amazon_Forest_Computer_Vision) ⚠️ Archived: Satellite Image tagging code using PyTorch / Keras with lots of PyTorch tricks. kaggle competition.
...
22. [pytorch-cpp-inference](https://github.com/Wizaron/pytorch-cpp-inference) ⭐ 225 | 🐛 1 | 🌐 C++ | 📅 2020-01-15: Serving PyTorch 1.0 Models as a Web Server in C++.
