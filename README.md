...
1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,234 | 🐛 2,434 | 🌐 Python | 📅 2026-09-16: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,462 | 🐛 315 | 🌐 Python | 📅 2026-09-16: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,556 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-15: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,173 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,961 | 🐛 60 | 🌐 Python | 📅 2026-09-16: End-to-End Speech Processing Toolkit espnet.github.io/espnet
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,939 | 🐛 339 | 🌐 Python | 📅 2026-09-15: simple audio I/O for pytorch.
...
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,929 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,913 | 🐛 1,222 | 🌐 Python | 📅 2026-09-15: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,359 | 🐛 197 | 🌐 Python | 📅 2026-09-16: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,968 | 🐛 312 | 🌐 Python | 📅 2026-09-15: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,949 | 🐛 870 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,810 | 🐛 108 | 🌐 Python | 📅 2026-09-14 - Lightly is a computer vision framework for self-supervised learning.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,054 | 🐛 290 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,825 | 🐛 3,599 | 🌐 Python | 📅 2026-09-16: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,344 | 🐛 1,085 | 🌐 Python | 📅 2026-09-14: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,142 | 🐛 270 | 🌐 Jupyter Notebook | 📅 2026-09-14: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,083 | 🐛 1,334 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,359 | 🐛 197 | 🌐 Python | 📅 2026-09-16: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,868 | 🐛 102 | 🌐 Python | 📅 2026-09-14 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
10. [EfficientNet PyTorch](https://github.com/lukemelas/EfficientNet-PyTorch) ⭐ 8,217 | 🐛 167 | 🌐 Python | 📅 2022-04-08: It contains an op-for-op PyTorch reimplementation of EfficientNet, along with pre-trained models and examples.
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,173 | 🐛 29 | 🌐 Python | 📅 2026-09-09: PyTorch library aimed at accelerating 3D deep learning research
...
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,910 | 🐛 422 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,910 | 🐛 422 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
28. [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,384 | 🐛 5 | 🌐 Python | 📅 2026-07-08: High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,801 | 🐛 187 | 🌐 Python | 📅 2026-09-15: Adaptive Experimentation Platform
...
40. [cvxpylayers](https://github.com/cvxgrp/cvxpylayers) ⭐ 2,135 | 🐛 30 | 🌐 Python | 📅 2026-09-16: cvxpylayers is a Python library for constructing differentiable convex optimization layers in PyTorch
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,822 | 🐛 37 | 🌐 Python | 📅 2026-09-16: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
86. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 475 | 🐛 0 | 🌐 Python | 📅 2026-09-15: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,448 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,148 | 🐛 60 | 🌐 Python | 📅 2026-09-15: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,494 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
...
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,328 | 🐛 259 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
11. [d2l-pytorch](https://github.com/dsgiitr/d2l-pytorch) ⭐ 4,365 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-07-25: This is an attempt to modify Dive into Deep Learning, Berkeley STAT 157 (Spring 2019) textbook's code into PyTorch.
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,213 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 6 | 🌐 C++ | 📅 2026-09-13: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,494 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,234 | 🐛 2,434 | 🌐 Python | 📅 2026-09-16: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,244 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,974 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
6. [yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,607 | 🐛 4 | 🌐 Python | 📅 2026-09-10: YOLOv3: Training and inference in PyTorch pjreddie.com/darknet/yolo
...
9. [deep-image-prior](https://github.com/DmitryUlyanov/deep-image-prior) ⭐ 8,091 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2023-04-27: Image restoration with neural networks but without learning.
...
78. [torchMoji](https://github.com/huggingface/torchMoji) ⭐ 920 | 🐛 21 | 🌐 Python | 📅 2024-02-12: A pyTorch implementation of the DeepMoji model: state-of-the-art deep learning model for analyzing sentiment, emotion, sarcasm etc.
...
3. [generative models](https://github.com/wiseodd/generative-models) ⭐ 7,489 | 🐛 30 | 🌐 Python | 📅 2024-03-24: Collection of generative models, e.g. GAN, VAE in Tensorflow, Keras, and Pytorch. <http://wiseodd.github.io>
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,488 | 🐛 248 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
...
7. [AlphaZero\_Gomoku](https://github.com/junxiaosong/AlphaZero_Gomoku) ⭐ 3,630 | 🐛 80 | 🌐 Python | 📅 2024-04-24: An implementation of the AlphaZero algorithm for Gomoku (also called Gobang or Five in a Row)
