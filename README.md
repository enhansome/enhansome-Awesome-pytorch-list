...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,695 | 🐛 72 | 🌐 Python | 📅 2026-08-27: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,627 | 🐛 2,401 | 🌐 Python | 📅 2026-08-30: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,358 | 🐛 297 | 🌐 Python | 📅 2026-08-30: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,792 | 🐛 180 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,485 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,169 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,946 | 🐛 56 | 🌐 Python | 📅 2026-08-30: End-to-End Speech Processing Toolkit espnet.github.io/espnet
9. [OpenNMT-py](https://github.com/OpenNMT/OpenNMT-py) ⭐ 7,013 | 🐛 23 | 🌐 Python | 📅 2025-10-14: Open-Source Neural Machine Translation in PyTorch <http://opennmt.net>
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,932 | 🐛 338 | 🌐 Python | 📅 2026-08-29: simple audio I/O for pytorch.
...
30. [pytorch-wavenet](https://github.com/vincentherrmann/pytorch-wavenet) ⭐ 1,030 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2020-09-17: An implementation of WaveNet with fast generation
...
42. [torch-metrics](https://github.com/enochkan/torch-metrics) ⭐ 110 | 🐛 2 | 🌐 Python | 📅 2026-08-29: Metrics for model evaluation in pytorch
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,693 | 🐛 586 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,894 | 🐛 1,960 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,893 | 🐛 1,198 | 🌐 Python | 📅 2026-08-29: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,334 | 🐛 123 | 🌐 Python | 📅 2026-08-30: Differentiable computer vision library.
...
7. [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,934 | 🐛 869 | 🌐 Python | 📅 2024-08-13: MMSegmentation is a semantic segmentation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,860 | 🐛 333 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,520 | 🐛 656 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,147 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,800 | 🐛 103 | 🌐 Python | 📅 2026-08-28 - Lightly is a computer vision framework for self-supervised learning.
...
35. [neural-dream](https://github.com/ProGamerGov/neural-dream) ⭐ 147 | 🐛 10 | 🌐 Python | 📅 2021-09-29: A PyTorch implementation of the DeepDream algorithm. Creates dream-like hallucinogenic visuals.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,045 | 🐛 286 | 🌐 Python | 📅 2026-08-27: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,589 | 🐛 94 | 🌐 Jupyter Notebook | 📅 2026-08-27: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,651 | 🐛 3,543 | 🌐 Python | 📅 2026-08-29: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,316 | 🐛 1,082 | 🌐 Python | 📅 2026-08-25: Rapid research framework for Pytorch. The researcher's version of keras.
...
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,045 | 🐛 1,317 | 🌐 Python | 📅 2026-08-24: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,334 | 🐛 123 | 🌐 Python | 📅 2026-08-30: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,841 | 🐛 112 | 🌐 Python | 📅 2026-08-26 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,996 | 🐛 770 | 🌐 Python | 📅 2026-08-27: An Experimental PyTorch Extension(will be deprecated at a later point)
10. [EfficientNet PyTorch](https://github.com/lukemelas/EfficientNet-PyTorch) ⭐ 8,221 | 🐛 167 | 🌐 Python | 📅 2022-04-08: It contains an op-for-op PyTorch reimplementation of EfficientNet, along with pre-trained models and examples.
...
14. [pytorch-metric-learning](https://github.com/KevinMusgrave/pytorch-metric-learning) ⭐ 6,339 | 🐛 77 | 🌐 Python | 📅 2025-08-17: The easiest way to use metric learning in your application. Modular, flexible, and extensible. Written in PyTorch.
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,161 | 🐛 28 | 🌐 Python | 📅 2026-08-24: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,779 | 🐛 188 | 🌐 Python | 📅 2026-08-28: Ignite is a high-level library to help with training neural networks in PyTorch.
...
38. [RepDistiller](https://github.com/HobbitLong/RepDistiller) ⭐ 2,438 | 🐛 34 | 🌐 Python | 📅 2023-10-16: Contrastive Representation Distillation (CRD), and benchmark of recent knowledge distillation methods
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,824 | 🐛 32 | 🌐 Python | 📅 2026-08-30: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,372 | 🐛 32 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,108 | 🐛 54 | 🌐 Python | 📅 2026-08-28: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,470 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,019 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,299 | 🐛 258 | 🌐 Python | 📅 2026-08-26: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,116 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
15. [code-of-learn-deep-learning-with-pytorch](https://github.com/SherlockLiao/code-of-learn-deep-learning-with-pytorch) ⭐ 2,875 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2024-03-04: This is code of book "Learn Deep Learning with PyTorch" item.jd.com/17915495606.html
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,137 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,470 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,627 | 🐛 2,401 | 🌐 Python | 📅 2026-08-30: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,960 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,548 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
22. [Person-reID\_pytorch](https://github.com/layumi/Person_reID_baseline_pytorch) ⭐ 4,447 | 🐛 174 | 🌐 Python | 📅 2026-07-18: PyTorch for Person re-ID.
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,636 | 🐛 3 | 📅 2026-07-22**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
2. [pytorch notebook: docker-stack](https://hub.docker.com/r/escong/pytorch-notebook/): A project similar to [Jupyter Notebook Scientific Python Stack](https://github.com/jupyter/docker-stacks/tree/master/scipy-notebook) ⭐ 8,463 | 🐛 8 | 🌐 Python | 📅 2026-08-24
...
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,902 | 🐛 163 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
7. [AlphaZero\_Gomoku](https://github.com/junxiaosong/AlphaZero_Gomoku) ⭐ 3,625 | 🐛 80 | 🌐 Python | 📅 2024-04-24: An implementation of the AlphaZero algorithm for Gomoku (also called Gobang or Five in a Row)
...
11. [hasktorch](https://github.com/hasktorch/hasktorch) ⭐ 1,211 | 🐛 88 | 🌐 Haskell | 📅 2026-08-19: Tensors and neural networks in Haskell
