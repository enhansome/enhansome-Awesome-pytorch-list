...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,696 | 🐛 72 | 🌐 Python | 📅 2026-08-30: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 164,738 | 🐛 2,394 | 🌐 Python | 📅 2026-09-03: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,382 | 🐛 310 | 🌐 Python | 📅 2026-09-02: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
3. [flair](https://github.com/zalandoresearch/flair) ⭐ 14,383 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
...
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,503 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-09-02: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,170 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,948 | 🐛 57 | 🌐 Python | 📅 2026-09-03: End-to-End Speech Processing Toolkit espnet.github.io/espnet
9. [OpenNMT-py](https://github.com/OpenNMT/OpenNMT-py) ⭐ 7,014 | 🐛 23 | 🌐 Python | 📅 2025-10-14: Open-Source Neural Machine Translation in PyTorch <http://opennmt.net>
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,933 | 🐛 339 | 🌐 Python | 📅 2026-09-02: simple audio I/O for pytorch.
...
18. [pytorch-kaldi](https://github.com/mravanelli/pytorch-kaldi) ⭐ 2,405 | 🐛 26 | 🌐 Python | 📅 2022-03-14: pytorch-kaldi is a project for developing state-of-the-art DNN/RNN hybrid speech recognition systems. The DNN part is managed by pytorch, while feature extraction, label computation, and decoding are performed with the kaldi toolkit.
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,693 | 🐛 588 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,904 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,899 | 🐛 1,203 | 🌐 Python | 📅 2026-09-02: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,342 | 🐛 118 | 🌐 Python | 📅 2026-09-03: Differentiable computer vision library.
6. [pytorch3d](https://github.com/facebookresearch/pytorch3d) ⭐ 9,963 | 🐛 312 | 🌐 Python | 📅 2026-08-27: PyTorch3D is FAIR's library of reusable components for deep learning with 3D data pytorch3d.org
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,870 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
10. [face-alignment](https://github.com/1adrianb/face-alignment) ⭐ 7,535 | 🐛 91 | 🌐 Python | 📅 2026-04-06: :fire: 2D and 3D Face alignment library build using pytorch adrianbulat.com
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,458 | 🐛 69 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,525 | 🐛 655 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
14. [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,149 | 🐛 319 | 🌐 Python | 📅 2026-03-18: MMAction2 is OpenMMLab's next generation action understanding toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,044 | 🐛 286 | 🌐 Python | 📅 2026-09-03: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
2. [botorch](https://github.com/pytorch/botorch) ⭐ 3,591 | 🐛 94 | 🌐 Jupyter Notebook | 📅 2026-08-27: Bayesian optimization in PyTorch
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,690 | 🐛 3,545 | 🌐 Python | 📅 2026-09-03: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,316 | 🐛 1,078 | 🌐 Python | 📅 2026-09-01: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,131 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2026-09-03: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,056 | 🐛 1,321 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,342 | 🐛 118 | 🌐 Python | 📅 2026-09-03: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,842 | 🐛 118 | 🌐 Python | 📅 2026-09-03 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
12. [PyTorch-VAE](https://github.com/AntixK/PyTorch-VAE) ⭐ 7,669 | 🐛 68 | 🌐 Python | 📅 2025-03-21: A Collection of Variational Autoencoders (VAE) in PyTorch.
...
15. [inferno-sklearn](https://github.com/dnouri/inferno) ⭐ 6,176 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-08-27: A scikit-learn compatible neural network library that wraps pytorch.
16. [skorch](https://github.com/dnouri/skorch) ⭐ 6,176 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-08-27: A scikit-learn compatible neural network library that wraps pytorch
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,164 | 🐛 30 | 🌐 Python | 📅 2026-09-03: PyTorch library aimed at accelerating 3D deep learning research
18. [pytorch-OpCounter](https://github.com/Lyken17/pytorch-OpCounter) ⭐ 5,075 | 🐛 84 | 🌐 Python | 📅 2024-07-08: Count the FLOPs of your PyTorch model.
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,781 | 🐛 190 | 🌐 Python | 📅 2026-09-02: Ignite is a high-level library to help with training neural networks in PyTorch.
...
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,906 | 🐛 417 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,906 | 🐛 417 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,175 | 🐛 138 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,795 | 🐛 185 | 🌐 Python | 📅 2026-08-28: Adaptive Experimentation Platform
38. [RepDistiller](https://github.com/HobbitLong/RepDistiller) ⭐ 2,439 | 🐛 34 | 🌐 Python | 📅 2023-10-16: Contrastive Representation Distillation (CRD), and benchmark of recent knowledge distillation methods
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,824 | 🐛 37 | 🌐 Python | 📅 2026-09-01: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
46. [bindsnet](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,695 | 🐛 16 | 🌐 Python | 📅 2026-09-02: A Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch
...
58. [mushroom](https://github.com/AIRLab-POLIMI/mushroom) ⭐ 944 | 🐛 4 | 🌐 Python | 📅 2026-09-03: Python library for Reinforcement Learning experiments.
...
78. [torchani](https://github.com/aiqm/torchani) ⭐ 555 | 🐛 8 | 🌐 Python | 📅 2026-08-18: Accurate Neural Network Potential on PyTorch aiqm.github.io/torchani
...
80. [pro\_gan\_pytorch](https://github.com/akanimax/pro_gan_pytorch) ⭐ 541 | 🐛 5 | 🌐 Python | 📅 2023-10-03: ProGAN package implemented as an extension of PyTorch nn.Module
...
87. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 474 | 🐛 6 | 🌐 Python | 📅 2026-09-02: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,391 | 🐛 32 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,120 | 🐛 54 | 🌐 Python | 📅 2026-09-01: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
3. [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,477 | 🐛 89 | 🌐 Python | 📅 2023-08-15: tutorial for researchers to learn deep learning with pytorch.
4. [pytorch examples](https://github.com/pytorch/examples) ⭐ 24,026 | 🐛 253 | 🌐 Python | 📅 2025-09-01:  A repository showcasing examples of using pytorch
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,310 | 🐛 257 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
12. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 4,136 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-05-25: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
...
16. [pytorch-cpp](https://github.com/prabhuomkar/pytorch-cpp) ⭐ 2,138 | 🐛 3 | 🌐 C++ | 📅 2025-08-25: C++ implementations of PyTorch tutorials for deep learning researchers (based on the Python tutorials from [pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,477 | 🐛 89 | 🌐 Python | 📅 2023-08-15).
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 164,738 | 🐛 2,394 | 🌐 Python | 📅 2026-09-03: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
...
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,783 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
...
12. [face-alignment](https://github.com/1adrianb/face-alignment) ⭐ 7,535 | 🐛 91 | 🌐 Python | 📅 2026-04-06: Pytorch implementation of the paper "How far are we from solving the 2D & 3D Face Alignment problem? (and a dataset of 230,000 3D facial landmarks)", ICCV 2017
...
21. [TCN](https://github.com/locuslab/TCN) ⭐ 4,551 | 🐛 20 | 🌐 Python | 📅 2022-03-28: Sequence modeling benchmarks and temporal convolutional networks locuslab/TCN
...
70. [graphsage-simple](https://github.com/williamleif/graphsage-simple) ⭐ 1,053 | 🐛 20 | 🌐 Python | 📅 2020-05-11: Simple reference implementation of GraphSAGE.
...
110. [pytorch-pose-hg-3d](https://github.com/xingyizhou/pytorch-pose-hg-3d) ⭐ 611 | 🐛 36 | 🌐 Python | 📅 2023-06-21: PyTorch implementation for 3D human pose estimation
...
157. [pytorch-i-revnet](https://github.com/jhjacobsen/pytorch-i-revnet) ⭐ 397 | 🐛 3 | 🌐 Python | 📅 2021-02-16: Pytorch implementation of i-RevNets.
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,483 | 🐛 249 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
5. [pytorch-template](https://github.com/victoresque/pytorch-template) ⭐ 5,118 | 🐛 23 | 🌐 Python | 📅 2024-06-04: PyTorch template project
6. [deep-person-reid](https://github.com/KaiyangZhou/deep-person-reid) ⭐ 4,905 | 🐛 163 | 🌐 Python | 📅 2026-01-09: Pytorch implementation of deep person re-identification approaches.
...
9. [DoodleMaster](https://github.com/karanchahal/DoodleMaster) ⭐ 2,407 | 🐛 2 | 🌐 JavaScript | 📅 2019-10-31: "Don't code your UI, Draw it !"
