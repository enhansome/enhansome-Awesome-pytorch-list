...
1. [Captum](https://github.com/pytorch/captum) ⭐ 5,701 | 🐛 75 | 🌐 Python | 📅 2026-09-13: Model interpretability and understanding for PyTorch.
2. [pytorch](http://pytorch.org): Tensors and Dynamic neural networks in Python with strong GPU acceleration.

### NLP & Speech Processing:

1. [transformers](https://github.com/huggingface/transformers) ⭐ 166,434 | 🐛 2,424 | 🌐 Python | 📅 2026-09-19: huggingface Transformers: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. huggingface.co/transformers
2. [NeMo](https://github.com/NVIDIA/NeMo) ⭐ 18,476 | 🐛 296 | 🌐 Python | 📅 2026-09-19: Neural Modules: a toolkit for conversational AI nvidia.github.io/NeMo
...
5. [speechbrain](https://github.com/speechbrain/speechbrain) ⭐ 11,828 | 🐛 189 | 🌐 Python | 📅 2026-08-27: SpeechBrain is an open-source and all-in-one speech toolkit based on PyTorch.
6. [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,574 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-09-18: Neural building blocks for speaker diarization: speech activity detection, speaker change detection, speaker embedding
7. [TTS](https://github.com/mozilla/TTS) ⭐ 10,173 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2023-11-09: Deep learning for Text2Speech
8. [espnet](https://github.com/espnet/espnet) ⭐ 9,964 | 🐛 77 | 🌐 Python | 📅 2026-09-20: End-to-End Speech Processing Toolkit espnet.github.io/espnet
9. [OpenNMT-py](https://github.com/OpenNMT/OpenNMT-py) ⭐ 7,015 | 🐛 23 | 🌐 Python | 📅 2025-10-14: Open-Source Neural Machine Translation in PyTorch <http://opennmt.net>
...
16. [audio](https://github.com/pytorch/audio) ⭐ 2,942 | 🐛 340 | 🌐 Python | 📅 2026-09-19: simple audio I/O for pytorch.
...
27. [voicefilter](https://github.com/mindslab-ai/voicefilter) ⭐ 1,221 | 🐛 13 | 🌐 Python | 📅 2024-07-25: Unofficial PyTorch implementation of Google AI's VoiceFilter system <http://swpark.me/voicefilter>
...
1. [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,717 | 🐛 591 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
2. [MMDetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,940 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: MMDetection is an open source object detection toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
3. [pytorch vision](https://github.com/pytorch/vision) ⭐ 17,917 | 🐛 1,223 | 🌐 Python | 📅 2026-09-19: Datasets, Transforms and Models specific to Computer Vision.
4. [albumentations](https://github.com/albu/albumentations) ⚠️ Archived: Fast image augmentation library.
5. [kornia](https://github.com/arraiyopensource/kornia) ⭐ 11,368 | 🐛 183 | 🌐 Python | 📅 2026-09-20: Differentiable computer vision library.
...
9. [MMPose](https://github.com/open-mmlab/mmpose) ⭐ 7,902 | 🐛 332 | 🌐 Python | 📅 2025-08-04: MMPose is a pose estimation toolbox and benchmark, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
11. [MMEditing](https://github.com/open-mmlab/mmediting) ⭐ 7,465 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2024-08-06: MMEditing is a image and video editing toolbox, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
12. [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,530 | 🐛 658 | 🌐 Python | 📅 2024-07-10: MMDetection3D is OpenMMLab's next-generation platform for general 3D object detection, a part of the [OpenMMLab project](https://open-mmlab.github.io/).
...
16. [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,812 | 🐛 107 | 🌐 Python | 📅 2026-09-18 - Lightly is a computer vision framework for self-supervised learning.
...
1. [pyro](https://github.com/uber/pyro) ⭐ 9,056 | 🐛 291 | 🌐 Python | 📅 2026-09-07: Deep universal probabilistic programming with Python and PyTorch <http://pyro.ai>
...
1. [ray](https://github.com/ray-project/ray) ⭐ 43,876 | 🐛 3,607 | 🌐 Python | 📅 2026-09-20: A fast and simple framework for building and running distributed applications. Ray is packaged with RLlib, a scalable reinforcement learning library, and Tune, a scalable hyperparameter tuning library. ray.io
2. [pytorch-lightning](https://github.com/williamFalcon/pytorch-lightning) ⭐ 31,354 | 🐛 1,087 | 🌐 Python | 📅 2026-09-17: Rapid research framework for Pytorch. The researcher's version of keras.
3. [fastai](https://github.com/fastai/fastai) ⭐ 28,181 | 🐛 270 | 🌐 Jupyter Notebook | 📅 2026-09-14: The fast.ai deep learning library, lessons, and tutorials
4. [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,093 | 🐛 1,341 | 🌐 Python | 📅 2026-09-01: Geometric Deep Learning Extension Library for PyTorch
...
6. [torchgeometry](https://github.com/arraiyopensource/torchgeometry) ⭐ 11,368 | 🐛 183 | 🌐 Python | 📅 2026-09-20: TGM: PyTorch Geometry
7. [accelerate](https://github.com/huggingface/accelerate) ⭐ 9,878 | 🐛 112 | 🌐 Python | 📅 2026-09-14 : A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision
...
9. [apex](https://github.com/NVIDIA/apex) ⭐ 8,997 | 🐛 770 | 🌐 Python | 📅 2026-09-14: An Experimental PyTorch Extension(will be deprecated at a later point)
...
17. [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,174 | 🐛 29 | 🌐 Python | 📅 2026-09-18: PyTorch library aimed at accelerating 3D deep learning research
...
19. [ignite](https://github.com/pytorch/ignite) ⭐ 4,785 | 🐛 186 | 🌐 Python | 📅 2026-09-09: Ignite is a high-level library to help with training neural networks in PyTorch.
...
22. [gpytorch](https://github.com/jrg365/gpytorch) ⭐ 3,913 | 🐛 422 | 🌐 Python | 📅 2026-07-10: GPyTorch is a Gaussian Process library, implemented using PyTorch. It is designed for creating flexible and modular Gaussian Process models with ease, so that you don't have to be an expert to use GPs.
23. [gpytorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,913 | 🐛 422 | 🌐 Python | 📅 2026-07-10: A highly efficient and modular implementation of Gaussian Processes in PyTorch.
...
25. [PyTorch-StudioGAN](https://github.com/POSTECH-CVLab/PyTorch-StudioGAN) ⭐ 3,482 | 🐛 40 | 🌐 Python | 📅 2024-08-09: StudioGAN is a Pytorch library providing implementations of representative Generative Adversarial Networks (GANs) for conditional/unconditional image generation. StudioGAN aims to offer an identical playground for modern GANs so that machine learning researchers can readily compare and analyze a new idea.
...
28. [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,385 | 🐛 5 | 🌐 Python | 📅 2026-07-08: High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
29. [webdataset](https://github.com/tmbdev/webdataset) ⭐ 3,196 | 🐛 138 | 🌐 Python | 📅 2026-02-09: WebDataset is a PyTorch Dataset (IterableDataset) implementation providing efficient access to datasets stored in POSIX tar archives.
...
37. [Ax](https://github.com/facebook/Ax) ⭐ 2,802 | 🐛 186 | 🌐 Python | 📅 2026-09-18: Adaptive Experimentation Platform
...
40. [cvxpylayers](https://github.com/cvxgrp/cvxpylayers) ⭐ 2,138 | 🐛 31 | 🌐 Python | 📅 2026-09-19: cvxpylayers is a Python library for constructing differentiable convex optimization layers in PyTorch
...
43. [Koila](https://github.com/rentruewang/koila) ⭐ 1,823 | 🐛 37 | 🌐 Python | 📅 2026-09-20: A simple wrapper around pytorch that prevents CUDA out of memory issues.
...
86. [pytorch-hessian-eigenthings](https://github.com/noahgolmant/pytorch-hessian-eigenthings) ⭐ 475 | 🐛 2 | 🌐 Python | 📅 2026-09-18: Efficient PyTorch Hessian eigendecomposition using the Hessian-vector product and stochastic power iteration.
...
1. [LabML NN](https://github.com/lab-ml/nn) ⭐ 67,469 | 🐛 33 | 🌐 Python | 📅 2026-01-22: A collection of PyTorch implementations of neural networks architectures and algorithms with side-by-side notes.
2. [pytorch-image-models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,161 | 🐛 50 | 🌐 Python | 📅 2026-09-18: PyTorch image models, scripts, pretrained weights -- (SE)ResNet/ResNeXT, DPN, EfficientNet, MobileNet-V3/V2/V1, MNASNet, Single-Path NAS, FBNet, and more.
...
5. [pytorch tutorials](https://github.com/pytorch/tutorials) ⭐ 9,336 | 🐛 259 | 🌐 Python | 📅 2026-09-03: Various pytorch tutorials.
...
9. [RL-Adventure-2](https://github.com/higgsfield/RL-Adventure-2) ⭐ 5,099 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-09-14: PyTorch4 tutorial of: actor critic / proximal policy optimization / acer / ddpg / twin dueling ddpg / soft actor critic / generative adversarial imitation learning / hindsight experience replay
10. [pytorch-sentiment-analysis](https://github.com/bentrevett/pytorch-sentiment-analysis) ⭐ 4,611 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-03-27: Tutorials on getting started with PyTorch and TorchText for sentiment analysis.
...
13. [RL-Adventure](https://github.com/higgsfield/RL-Adventure) ⭐ 3,179 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2021-11-04: Pytorch easy-to-follow step-by-step Deep Q Learning tutorial with clean readable code.
...
1. [pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,434 | 🐛 2,424 | 🌐 Python | 📅 2026-09-19: PyTorch version of Google AI's BERT model with script to load Google's pre-trained models
2. [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) ⭐ 25,246 | 🐛 589 | 🌐 Python | 📅 2025-08-06: PyTorch implementation for both unpaired and paired image-to-image translation.
...
4. [grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,978 | 🐛 160 | 🌐 Python | 📅 2026-08-13: Pytorch implementation of Grad-CAM
...
7. [attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch) ⭐ 9,797 | 🐛 83 | 🌐 Python | 📅 2024-04-16: A PyTorch implementation of the Transformer model in "Attention is All You Need".<https://github.com/thnkim/OpenFacePytorch> ⭐ 189 | 🐛 5 | 🌐 Python | 📅 2020-02-20
...
42. [PyKEEN](https://github.com/pykeen/pykeen) ⭐ 2,036 | 🐛 130 | 🌐 Python | 📅 2026-09-06: A Python library for learning and evaluating knowledge graph embeddings.
...
57. [attention-transfer](https://github.com/szagoruyko/attention-transfer) ⭐ 1,464 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2018-07-11: Attention transfer in pytorch, read the paper [here](https://arxiv.org/abs/1612.03928).
...
63. [AnimeGAN](https://github.com/jayleicn/animeGAN) ⭐ 1,276 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2022-08-24: A simple PyTorch Implementation of Generative Adversarial Networks, focusing on anime face drawing.
...
65. [voicefilter](https://github.com/mindslab-ai/voicefilter) ⭐ 1,221 | 🐛 13 | 🌐 Python | 📅 2024-07-25: Unofficial PyTorch implementation of Google AI's VoiceFilter system <http://swpark.me/voicefilter>.
...
107. [RandWireNN](https://github.com/seungwonpark/RandWireNN) ⭐ 683 | 🐛 3 | 🌐 Python | 📅 2019-06-26: Implementation of: "Exploring Randomly Wired Neural Networks for Image Recognition".
...
115. [pytorch-made](https://github.com/karpathy/pytorch-made) ⭐ 593 | 🐛 2 | 🌐 Python | 📅 2018-12-08: MADE (Masked Autoencoder Density Estimation) implementation in PyTorch
...
145. [PytorchNeuralStyleTransfer](https://github.com/leongatys/PytorchNeuralStyleTransfer) ⭐ 433 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2021-02-05: Implementation of Neural Style Transfer in Pytorch.
...
1. **[the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,643 | 🐛 3 | 📅 2026-07-22**: The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch.
...
4. [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,487 | 🐛 248 | 🌐 Rust | 📅 2026-08-23: Rust bindings for PyTorch.
